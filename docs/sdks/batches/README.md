...
import com.goshippo.shippo_sdk.models.components.ParcelInsurance;
import com.goshippo.shippo_sdk.models.components.ParcelInsuranceProvider;
import com.goshippo.shippo_sdk.models.components.ParcelTemplateCouriersPleaseEnum;
                        ...
                        .shipment(ShipmentCreateRequest.builder()
                            ...
                            .parcels(List.of(
                                Parcels.of(ParcelCreateFromTemplateRequest.builder()
                                    .massUnit(WeightUnitEnum.LB)
                                    .weight("1")
                                    .template(ParcelTemplateEnumSet.of(ParcelTemplateCouriersPleaseEnum.COURIERSPLEASE1KG_SATCHEL))
                                    .extra(ParcelExtra.builder()
                                        .cod(Cod.builder()
                                            .amount("5.5")
                                            .currency("USD")
                                ...
                                Parcels.of(ParcelCreateFromTemplateRequest.builder()
                                    .massUnit(WeightUnitEnum.LB)
                                    .weight("1")
                                    .template(ParcelTemplateEnumSet.of(ParcelTemplateDHLeCommerceEnum.DH_LE_CSM_FLATS))
                                    .extra(ParcelExtra.builder()
                                        .cod(Cod.builder()
                                            .amount("5.5")
                                            .currency("USD")
