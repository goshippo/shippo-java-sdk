...
```java
import com.goshippo.shippo_sdk.models.components.ServiceLevelRoyalMailEnum;

ServiceLevelRoyalMailEnum value = ServiceLevelRoyalMailEnum.ROYAL_MAIL_TRACKED_LETTER_BOXABLE24_NO_SIGNATURE;
```
