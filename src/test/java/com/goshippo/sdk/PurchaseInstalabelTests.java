...
import com.goshippo.sdk.models.components.InstantTransactionCreateRequest;
...
import com.goshippo.sdk.models.components.Transaction;
...
public class PurchaseInstalabelTests extends SdkProvider {
    ...
    public void shouldPurchaseInstalabel() throws Exception {
        ...
        final var parcels = List.of(com.goshippo.sdk.models.components.Parcels.of(ParcelCreateRequest.builder()
