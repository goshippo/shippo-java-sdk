...
public class CustomsItems implements
     ...
     */
    public com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsRequestBuilder list() {
        return new com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsRequestBuilder(this);
    }
     ...
     */
    public com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsResponse listDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsResponse list(
            Optional<? extends Long> page,
            Optional<? extends Long> results,
            Optional<? extends String> shippoApiVersion) throws Exception {
        com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsRequest request =
            com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsRequest
                .builder()
                .page(page)
                .results(results)
        ...
        _req.addQueryParams(Utils.getQueryParams(
                com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsRequest.class,
                request, 
        ...
        com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.ListCustomsItemsResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ObjectMapper _mapper = JSON.getMapper();
                com.shippo.shippo_java_sdk.models.components.CustomsItemPaginatedList _out = _mapper.readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.shippo.shippo_java_sdk.models.components.CustomsItemPaginatedList>() {});
     ...
     * @return The call builder
     */
    public com.shippo.shippo_java_sdk.models.operations.CreateCustomsItemRequestBuilder create() {
        return new com.shippo.shippo_java_sdk.models.operations.CreateCustomsItemRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.CreateCustomsItemResponse createDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.CreateCustomsItemResponse create(
        ...
        com.shippo.shippo_java_sdk.models.operations.CreateCustomsItemRequest request =
            com.shippo.shippo_java_sdk.models.operations.CreateCustomsItemRequest
                .builder()
                .shippoApiVersion(shippoApiVersion)
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.shippo.shippo_java_sdk.models.operations.CreateCustomsItemResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.CreateCustomsItemResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.CreateCustomsItemResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "201")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ObjectMapper _mapper = JSON.getMapper();
                com.shippo.shippo_java_sdk.models.components.CustomsItem _out = _mapper.readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.shippo.shippo_java_sdk.models.components.CustomsItem>() {});
     ...
     * @return The call builder
     */
    public com.shippo.shippo_java_sdk.models.operations.GetCustomsItemRequestBuilder get() {
        return new com.shippo.shippo_java_sdk.models.operations.GetCustomsItemRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.GetCustomsItemResponse get(
    ...
    public com.shippo.shippo_java_sdk.models.operations.GetCustomsItemResponse get(
            ...
            Optional<? extends Long> page,
            Optional<? extends String> shippoApiVersion) throws Exception {
        com.shippo.shippo_java_sdk.models.operations.GetCustomsItemRequest request =
            com.shippo.shippo_java_sdk.models.operations.GetCustomsItemRequest
                .builder()
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.shippo.shippo_java_sdk.models.operations.GetCustomsItemRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.shippo.shippo_java_sdk.models.operations.GetCustomsItemResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.GetCustomsItemResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.GetCustomsItemResponse _res = _resBuilder.build();
