...
import com.shippo.shippo_java_sdk.utils.SpeakeasyHTTPClient;
...
public class Shippo {
    ...
    public static class Builder {
        ...
        public Builder apiKeyHeader(String apiKeyHeader) {
            this.sdkConfiguration.securitySource = SecuritySource.of(com.shippo.shippo_java_sdk.models.components.Security.builder()
        ...
        public Builder serverURL(String serverUrl, java.util.Map<String, String> params) {
            this.sdkConfiguration.serverUrl = com.shippo.shippo_java_sdk.utils.Utils.templateUrl(serverUrl, params);
            return this;
        }
        ...
        void _hooks(com.shippo.shippo_java_sdk.utils.Hooks hooks) {
