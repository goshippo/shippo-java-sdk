...
public class CarrierParcelTemplates implements
     ...
     */
    public com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesRequestBuilder list() {
        return new com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesRequestBuilder(this);
    }
     ...
     */
    public com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesResponse listDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesResponse list(
        ...
        com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesRequest request =
            com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesRequest
                .builder()
                .include(include)
                .carrier(carrier)
        ...
        _req.addQueryParams(Utils.getQueryParams(
                com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesRequest.class,
                request, 
        ...
        com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.ListCarrierParcelTemplatesResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ObjectMapper _mapper = JSON.getMapper();
                java.util.List<com.shippo.shippo_java_sdk.models.components.CarrierParcelTemplate> _out = _mapper.readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<java.util.List<com.shippo.shippo_java_sdk.models.components.CarrierParcelTemplate>>() {});
                _res.withCarrierParcelTemplateListResponse(java.util.Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
                    _httpRes, 
     ...
     * @return The call builder
     */
    public com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateRequestBuilder get() {
        return new com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateResponse get(
    ...
    public com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateResponse get(
            ...
            Optional<? extends String> shippoApiVersion) throws Exception {
        com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateRequest request =
            com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateRequest
                .builder()
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.GetCarrierParcelTemplateResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ObjectMapper _mapper = JSON.getMapper();
                com.shippo.shippo_java_sdk.models.components.CarrierParcelTemplate _out = _mapper.readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.shippo.shippo_java_sdk.models.components.CarrierParcelTemplate>() {});
