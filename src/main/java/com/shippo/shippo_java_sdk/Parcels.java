...
public class Parcels implements
     ...
     */
    public com.shippo.shippo_java_sdk.models.operations.ListParcelsRequestBuilder list() {
        return new com.shippo.shippo_java_sdk.models.operations.ListParcelsRequestBuilder(this);
    }
     ...
     */
    public com.shippo.shippo_java_sdk.models.operations.ListParcelsResponse listDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.ListParcelsResponse list(
            Optional<? extends Long> page,
            Optional<? extends Long> results,
            Optional<? extends String> shippoApiVersion) throws Exception {
        com.shippo.shippo_java_sdk.models.operations.ListParcelsRequest request =
            com.shippo.shippo_java_sdk.models.operations.ListParcelsRequest
                .builder()
                .page(page)
                .results(results)
        ...
        _req.addQueryParams(Utils.getQueryParams(
                com.shippo.shippo_java_sdk.models.operations.ListParcelsRequest.class,
                request, 
        ...
        com.shippo.shippo_java_sdk.models.operations.ListParcelsResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.ListParcelsResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.ListParcelsResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ObjectMapper _mapper = JSON.getMapper();
                com.shippo.shippo_java_sdk.models.components.ParcelPaginatedList _out = _mapper.readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.shippo.shippo_java_sdk.models.components.ParcelPaginatedList>() {});
     ...
     * @return The call builder
     */
    public com.shippo.shippo_java_sdk.models.operations.CreateParcelRequestBuilder create() {
        return new com.shippo.shippo_java_sdk.models.operations.CreateParcelRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.CreateParcelResponse createDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.CreateParcelResponse create(
        ...
        com.shippo.shippo_java_sdk.models.operations.CreateParcelRequest request =
            com.shippo.shippo_java_sdk.models.operations.CreateParcelRequest
                .builder()
                .shippoApiVersion(shippoApiVersion)
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.shippo.shippo_java_sdk.models.operations.CreateParcelResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.CreateParcelResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.CreateParcelResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "201")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ObjectMapper _mapper = JSON.getMapper();
                com.shippo.shippo_java_sdk.models.components.Parcel _out = _mapper.readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.shippo.shippo_java_sdk.models.components.Parcel>() {});
     ...
     * @return The call builder
     */
    public com.shippo.shippo_java_sdk.models.operations.GetParcelRequestBuilder get() {
        return new com.shippo.shippo_java_sdk.models.operations.GetParcelRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.GetParcelResponse get(
    ...
    public com.shippo.shippo_java_sdk.models.operations.GetParcelResponse get(
            String parcelId,
            Optional<? extends String> shippoApiVersion) throws Exception {
        com.shippo.shippo_java_sdk.models.operations.GetParcelRequest request =
            com.shippo.shippo_java_sdk.models.operations.GetParcelRequest
                .builder()
                .parcelId(parcelId)
                .shippoApiVersion(shippoApiVersion)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.shippo.shippo_java_sdk.models.operations.GetParcelRequest.class,
                _baseUrl,
                "/parcels/{ParcelId}",
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.shippo.shippo_java_sdk.models.operations.GetParcelResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.GetParcelResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.GetParcelResponse _res = _resBuilder.build();
