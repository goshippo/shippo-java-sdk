...
public class Orders implements
     ...
     */
    public com.shippo.shippo_java_sdk.models.operations.ListOrdersRequestBuilder list() {
        return new com.shippo.shippo_java_sdk.models.operations.ListOrdersRequestBuilder(this);
    }
     ...
     */
    public com.shippo.shippo_java_sdk.models.operations.ListOrdersResponse listDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.ListOrdersResponse list(
            Optional<? extends Long> page,
            Optional<? extends Long> results,
            Optional<? extends String> shippoApiVersion) throws Exception {
        com.shippo.shippo_java_sdk.models.operations.ListOrdersRequest request =
            com.shippo.shippo_java_sdk.models.operations.ListOrdersRequest
                .builder()
                .page(page)
                .results(results)
        ...
        _req.addQueryParams(Utils.getQueryParams(
                com.shippo.shippo_java_sdk.models.operations.ListOrdersRequest.class,
                request, 
        ...
        com.shippo.shippo_java_sdk.models.operations.ListOrdersResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.ListOrdersResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.ListOrdersResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ObjectMapper _mapper = JSON.getMapper();
                com.shippo.shippo_java_sdk.models.components.OrderPaginatedList _out = _mapper.readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.shippo.shippo_java_sdk.models.components.OrderPaginatedList>() {});
     ...
     * @return The call builder
     */
    public com.shippo.shippo_java_sdk.models.operations.CreateOrderRequestBuilder create() {
        return new com.shippo.shippo_java_sdk.models.operations.CreateOrderRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.CreateOrderResponse createDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.CreateOrderResponse create(
        ...
        com.shippo.shippo_java_sdk.models.operations.CreateOrderRequest request =
            com.shippo.shippo_java_sdk.models.operations.CreateOrderRequest
                .builder()
                .shippoApiVersion(shippoApiVersion)
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.shippo.shippo_java_sdk.models.operations.CreateOrderResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.CreateOrderResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.CreateOrderResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "201")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ObjectMapper _mapper = JSON.getMapper();
                com.shippo.shippo_java_sdk.models.components.Order _out = _mapper.readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.shippo.shippo_java_sdk.models.components.Order>() {});
     ...
     * @return The call builder
     */
    public com.shippo.shippo_java_sdk.models.operations.GetOrderRequestBuilder get() {
        return new com.shippo.shippo_java_sdk.models.operations.GetOrderRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.shippo.shippo_java_sdk.models.operations.GetOrderResponse get(
    ...
    public com.shippo.shippo_java_sdk.models.operations.GetOrderResponse get(
            String orderId,
            Optional<? extends String> shippoApiVersion) throws Exception {
        com.shippo.shippo_java_sdk.models.operations.GetOrderRequest request =
            com.shippo.shippo_java_sdk.models.operations.GetOrderRequest
                .builder()
                .orderId(orderId)
                .shippoApiVersion(shippoApiVersion)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.shippo.shippo_java_sdk.models.operations.GetOrderRequest.class,
                _baseUrl,
                "/orders/{OrderId}",
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.shippo.shippo_java_sdk.models.operations.GetOrderResponse.Builder _resBuilder = 
            com.shippo.shippo_java_sdk.models.operations.GetOrderResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.shippo.shippo_java_sdk.models.operations.GetOrderResponse _res = _resBuilder.build();
