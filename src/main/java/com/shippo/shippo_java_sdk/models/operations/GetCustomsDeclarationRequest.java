...
public class GetCustomsDeclarationRequest {
     ...
     * The page number you want to select
     */
    public GetCustomsDeclarationRequest withPage(Optional<? extends Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * String used to pick a non-default API version to use
     */
    public GetCustomsDeclarationRequest withShippoApiVersion(Optional<? extends String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = shippoApiVersion;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            java.util.Objects.deepEquals(this.customsDeclarationId, other.customsDeclarationId) &&
