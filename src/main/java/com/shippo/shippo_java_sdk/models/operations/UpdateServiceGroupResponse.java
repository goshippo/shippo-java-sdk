...
public class UpdateServiceGroupResponse implements com.shippo.shippo_java_sdk.utils.Response {
    ...
    public UpdateServiceGroupResponse withServiceGroup(com.shippo.shippo_java_sdk.models.components.ServiceGroup serviceGroup) {
        Utils.checkNotNull(serviceGroup, "serviceGroup");
        this.serviceGroup = Optional.ofNullable(serviceGroup);
        return this;
    }

    public UpdateServiceGroupResponse withServiceGroup(Optional<? extends com.shippo.shippo_java_sdk.models.components.ServiceGroup> serviceGroup) {
        Utils.checkNotNull(serviceGroup, "serviceGroup");
        this.serviceGroup = serviceGroup;
        return this;
    }
