...
public class CreateCustomsDeclarationRequestBuilder {
    ...
    public CreateCustomsDeclarationRequestBuilder customsDeclarationCreateRequest(com.shippo.shippo_java_sdk.models.components.CustomsDeclarationCreateRequest customsDeclarationCreateRequest) {
        Utils.checkNotNull(customsDeclarationCreateRequest, "customsDeclarationCreateRequest");
        this.customsDeclarationCreateRequest = Optional.of(customsDeclarationCreateRequest);
        return this;
    }

    public CreateCustomsDeclarationRequestBuilder customsDeclarationCreateRequest(Optional<? extends com.shippo.shippo_java_sdk.models.components.CustomsDeclarationCreateRequest> customsDeclarationCreateRequest) {
        Utils.checkNotNull(customsDeclarationCreateRequest, "customsDeclarationCreateRequest");
