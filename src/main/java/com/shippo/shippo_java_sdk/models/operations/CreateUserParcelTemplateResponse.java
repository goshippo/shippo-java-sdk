...
public class CreateUserParcelTemplateResponse implements com.shippo.shippo_java_sdk.utils.Response {
    ...
    public CreateUserParcelTemplateResponse withUserParcelTemplate(com.shippo.shippo_java_sdk.models.components.UserParcelTemplate userParcelTemplate) {
        Utils.checkNotNull(userParcelTemplate, "userParcelTemplate");
        this.userParcelTemplate = Optional.ofNullable(userParcelTemplate);
        return this;
    }

    public CreateUserParcelTemplateResponse withUserParcelTemplate(Optional<? extends com.shippo.shippo_java_sdk.models.components.UserParcelTemplate> userParcelTemplate) {
        Utils.checkNotNull(userParcelTemplate, "userParcelTemplate");
        this.userParcelTemplate = userParcelTemplate;
        return this;
    }
