...
public class InitiateOauth2SigninCarrierAccountsResponseBody extends RuntimeException {
    ...
    public InitiateOauth2SigninCarrierAccountsResponseBody withTitle(String title) {
        Utils.checkNotNull(title, "title");
        this.title = Optional.ofNullable(title);
        return this;
    }
    
    public InitiateOauth2SigninCarrierAccountsResponseBody withTitle(Optional<? extends String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }

    public InitiateOauth2SigninCarrierAccountsResponseBody withDetail(String detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = Optional.ofNullable(detail);
        return this;
    }
    
    public InitiateOauth2SigninCarrierAccountsResponseBody withDetail(Optional<? extends String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public InitiateOauth2SigninCarrierAccountsResponseBody withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public InitiateOauth2SigninCarrierAccountsResponseBody withRawResponse(Optional<? extends HttpResponse<InputStream>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InitiateOauth2SigninCarrierAccountsResponseBody other = (InitiateOauth2SigninCarrierAccountsResponseBody) o;
        return
    ...
    public String toString() {
        return Utils.toString(InitiateOauth2SigninCarrierAccountsResponseBody.class,
                "title", title,
                "detail", detail,
    ...
    public final static class Builder {
        ...
        public InitiateOauth2SigninCarrierAccountsResponseBody build() {
