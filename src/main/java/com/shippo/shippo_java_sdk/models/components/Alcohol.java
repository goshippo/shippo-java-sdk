...
public class Alcohol {
    ...
    private Optional<? extends Boolean> containsAlcohol;
    ...
    @JsonCreator
    public Alcohol(
            @JsonProperty("contains_alcohol") Optional<? extends Boolean> containsAlcohol,
     ...
     */
    @JsonIgnore
    public Optional<? extends Boolean> containsAlcohol() {
     ...
     */
    @JsonIgnore
    public Optional<? extends RecipientType> recipientType() {
     ...
     * Mandatory for Fedex and UPS. Specifies that the package contains Alcohol.
     */
    public Alcohol withContainsAlcohol(Optional<? extends Boolean> containsAlcohol) {
        Utils.checkNotNull(containsAlcohol, "containsAlcohol");
        this.containsAlcohol = containsAlcohol;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            java.util.Objects.deepEquals(this.containsAlcohol, other.containsAlcohol) &&
            java.util.Objects.deepEquals(this.recipientType, other.recipientType);
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends Boolean> containsAlcohol = Optional.empty();
         ...
         * Mandatory for Fedex and UPS. Specifies that the package contains Alcohol.
         */
        public Builder containsAlcohol(Optional<? extends Boolean> containsAlcohol) {
            Utils.checkNotNull(containsAlcohol, "containsAlcohol");
            this.containsAlcohol = containsAlcohol;
            return this;
        }
