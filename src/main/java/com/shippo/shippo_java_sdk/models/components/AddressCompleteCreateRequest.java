...
public class AddressCompleteCreateRequest {
    ...
    public AddressCompleteCreateRequest(
            ...
            String zip,
            String country) {
        this(name, Optional.empty(), street1, Optional.empty(), Optional.empty(), Optional.empty(), city, state, zip, country, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    }
    ...
    @JsonIgnore
    public Optional<? extends Boolean> validate() {
        return validate;
    }
     ...
     * Latitude of address
     */
    public AddressCompleteCreateRequest withLatitude(double latitude) {
        Utils.checkNotNull(latitude, "latitude");
     ...
     * Latitude of address
     */
    public AddressCompleteCreateRequest withLatitude(Optional<? extends Double> latitude) {
        Utils.checkNotNull(latitude, "latitude");
        this.latitude = latitude;
        return this;
    }
     ...
     * Longitude of address
     */
    public AddressCompleteCreateRequest withLongitude(double longitude) {
        Utils.checkNotNull(longitude, "longitude");
     ...
     * Longitude of address
     */
    public AddressCompleteCreateRequest withLongitude(Optional<? extends Double> longitude) {
        Utils.checkNotNull(longitude, "longitude");
        this.longitude = longitude;
        return this;
    }
