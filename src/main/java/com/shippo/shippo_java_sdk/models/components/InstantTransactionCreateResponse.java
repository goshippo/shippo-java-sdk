...
public class InstantTransactionCreateResponse {
    ...
    private Optional<? extends java.util.List<InstantTransactionCreateResponseMessages>> messages;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("rate")
    private Optional<? extends InstantTransactionRate> rate;

    @JsonCreator
    public InstantTransactionCreateResponse(
            ...
            @JsonProperty("messages") Optional<? extends java.util.List<InstantTransactionCreateResponseMessages>> messages,
            ...
            @JsonProperty("rate") Optional<? extends InstantTransactionRate> rate) {
     ...
     */
    @JsonIgnore
    public Optional<? extends java.util.List<InstantTransactionCreateResponseMessages>> messages() {
        return messages;
    }
    ...
    @JsonIgnore
    public Optional<? extends InstantTransactionRate> rate() {
        return rate;
    }
     ...
     * A value will only be returned if the Transactions has been processed successfully and if the shipment is international.
     */
    public InstantTransactionCreateResponse withCommercialInvoiceUrl(String commercialInvoiceUrl) {
        Utils.checkNotNull(commercialInvoiceUrl, "commercialInvoiceUrl");
     ...
     * A value will only be returned if the Transactions has been processed successfully and if the shipment is international.
     */
    public InstantTransactionCreateResponse withCommercialInvoiceUrl(Optional<? extends String> commercialInvoiceUrl) {
        Utils.checkNotNull(commercialInvoiceUrl, "commercialInvoiceUrl");
        this.commercialInvoiceUrl = commercialInvoiceUrl;
        return this;
    }
     ...
     * The estimated time of arrival according to the carrier.
     */
    public InstantTransactionCreateResponse withEta(String eta) {
        Utils.checkNotNull(eta, "eta");
     ...
     * The estimated time of arrival according to the carrier.
     */
    public InstantTransactionCreateResponse withEta(Optional<? extends String> eta) {
        Utils.checkNotNull(eta, "eta");
        this.eta = eta;
        return this;
    }
     ...
     * &lt;a href="https://apps.goshippo.com/settings/labels"&gt;the Shippo dashboard.&lt;/a&gt;
     */
    public InstantTransactionCreateResponse withLabelFileType(LabelFileTypeEnum labelFileType) {
        Utils.checkNotNull(labelFileType, "labelFileType");
     ...
     * &lt;a href="https://apps.goshippo.com/settings/labels"&gt;the Shippo dashboard.&lt;/a&gt;
     */
    public InstantTransactionCreateResponse withLabelFileType(Optional<? extends LabelFileTypeEnum> labelFileType) {
        Utils.checkNotNull(labelFileType, "labelFileType");
        this.labelFileType = labelFileType;
        return this;
    }
     ...
     * A value will only be returned if the Transactions has been processed successfully.
     */
    public InstantTransactionCreateResponse withLabelUrl(String labelUrl) {
        Utils.checkNotNull(labelUrl, "labelUrl");
     ...
     * A value will only be returned if the Transactions has been processed successfully.
     */
    public InstantTransactionCreateResponse withLabelUrl(Optional<? extends String> labelUrl) {
        Utils.checkNotNull(labelUrl, "labelUrl");
        this.labelUrl = labelUrl;
        return this;
    }
     ...
     * `message` (string): a publishable message containing further information.
     */
    public InstantTransactionCreateResponse withMessages(java.util.List<InstantTransactionCreateResponseMessages> messages) {
        Utils.checkNotNull(messages, "messages");
     ...
     * `message` (string): a publishable message containing further information.
     */
    public InstantTransactionCreateResponse withMessages(Optional<? extends java.util.List<InstantTransactionCreateResponseMessages>> messages) {
        Utils.checkNotNull(messages, "messages");
        this.messages = messages;
        return this;
    }
     ...
     * attach to the object.
     */
    public InstantTransactionCreateResponse withMetadata(String metadata) {
        Utils.checkNotNull(metadata, "metadata");
     ...
     * attach to the object.
     */
    public InstantTransactionCreateResponse withMetadata(Optional<? extends String> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
     ...
     * Date and time of Transaction creation.
     */
    public InstantTransactionCreateResponse withObjectCreated(OffsetDateTime objectCreated) {
        Utils.checkNotNull(objectCreated, "objectCreated");
     ...
     * Date and time of Transaction creation.
     */
    public InstantTransactionCreateResponse withObjectCreated(Optional<? extends OffsetDateTime> objectCreated) {
        Utils.checkNotNull(objectCreated, "objectCreated");
        this.objectCreated = objectCreated;
        return this;
    }
     ...
     * Unique identifier of the given Transaction object.
     */
    public InstantTransactionCreateResponse withObjectId(String objectId) {
        Utils.checkNotNull(objectId, "objectId");
     ...
     * Unique identifier of the given Transaction object.
     */
    public InstantTransactionCreateResponse withObjectId(Optional<? extends String> objectId) {
        Utils.checkNotNull(objectId, "objectId");
        this.objectId = objectId;
        return this;
    }
     ...
     * Username of the user who created the Transaction object.
     */
    public InstantTransactionCreateResponse withObjectOwner(String objectOwner) {
        Utils.checkNotNull(objectOwner, "objectOwner");
     ...
     * Username of the user who created the Transaction object.
     */
    public InstantTransactionCreateResponse withObjectOwner(Optional<? extends String> objectOwner) {
        Utils.checkNotNull(objectOwner, "objectOwner");
        this.objectOwner = objectOwner;
        return this;
    }
     ...
     * Indicates the validity of the enclosing object
     */
    public InstantTransactionCreateResponse withObjectState(ObjectStateEnum objectState) {
        Utils.checkNotNull(objectState, "objectState");
     ...
     * Indicates the validity of the enclosing object
     */
    public InstantTransactionCreateResponse withObjectState(Optional<? extends ObjectStateEnum> objectState) {
        Utils.checkNotNull(objectState, "objectState");
        this.objectState = objectState;
        return this;
    }
     ...
     * Date and time of last Transaction update.
     */
    public InstantTransactionCreateResponse withObjectUpdated(OffsetDateTime objectUpdated) {
        Utils.checkNotNull(objectUpdated, "objectUpdated");
     ...
     * Date and time of last Transaction update.
     */
    public InstantTransactionCreateResponse withObjectUpdated(Optional<? extends OffsetDateTime> objectUpdated) {
        Utils.checkNotNull(objectUpdated, "objectUpdated");
        this.objectUpdated = objectUpdated;
        return this;
    }
     ...
     * A value will only be returned if requested using qr_code_requested flag and the carrier provides such an option.
     */
    public InstantTransactionCreateResponse withQrCodeUrl(String qrCodeUrl) {
        Utils.checkNotNull(qrCodeUrl, "qrCodeUrl");
     ...
     * A value will only be returned if requested using qr_code_requested flag and the carrier provides such an option.
     */
    public InstantTransactionCreateResponse withQrCodeUrl(Optional<? extends String> qrCodeUrl) {
        Utils.checkNotNull(qrCodeUrl, "qrCodeUrl");
        this.qrCodeUrl = qrCodeUrl;
        return this;
    }
     ...
     * Indicates the status of the Transaction.
     */
    public InstantTransactionCreateResponse withStatus(TransactionStatusEnum status) {
        Utils.checkNotNull(status, "status");
     ...
     * Indicates the status of the Transaction.
     */
    public InstantTransactionCreateResponse withStatus(Optional<? extends TransactionStatusEnum> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Indicates whether the object has been created in test mode.
     */
    public InstantTransactionCreateResponse withTest(boolean test) {
        Utils.checkNotNull(test, "test");
     ...
     * Indicates whether the object has been created in test mode.
     */
    public InstantTransactionCreateResponse withTest(Optional<? extends Boolean> test) {
        Utils.checkNotNull(test, "test");
        this.test = test;
        return this;
    }
     ...
     * A value will only be returned if the Rate is for a trackable Shipment and if the Transactions has been processed successfully.
     */
    public InstantTransactionCreateResponse withTrackingNumber(String trackingNumber) {
        Utils.checkNotNull(trackingNumber, "trackingNumber");
     ...
     * A value will only be returned if the Rate is for a trackable Shipment and if the Transactions has been processed successfully.
     */
    public InstantTransactionCreateResponse withTrackingNumber(Optional<? extends String> trackingNumber) {
        Utils.checkNotNull(trackingNumber, "trackingNumber");
        this.trackingNumber = trackingNumber;
        return this;
    }
     ...
     * Indicates the high level status of the shipment.
     */
    public InstantTransactionCreateResponse withTrackingStatus(TrackingStatusEnum trackingStatus) {
        Utils.checkNotNull(trackingStatus, "trackingStatus");
     ...
     * Indicates the high level status of the shipment.
     */
    public InstantTransactionCreateResponse withTrackingStatus(Optional<? extends TrackingStatusEnum> trackingStatus) {
        Utils.checkNotNull(trackingStatus, "trackingStatus");
        this.trackingStatus = trackingStatus;
        return this;
    }
     ...
     * A value will only be returned if tracking is available and the carrier provides such a service.
     */
    public InstantTransactionCreateResponse withTrackingUrlProvider(String trackingUrlProvider) {
        Utils.checkNotNull(trackingUrlProvider, "trackingUrlProvider");
     ...
     * A value will only be returned if tracking is available and the carrier provides such a service.
     */
    public InstantTransactionCreateResponse withTrackingUrlProvider(Optional<? extends String> trackingUrlProvider) {
        Utils.checkNotNull(trackingUrlProvider, "trackingUrlProvider");
        this.trackingUrlProvider = trackingUrlProvider;
        return this;
    }

    public InstantTransactionCreateResponse withRate(InstantTransactionRate rate) {
        Utils.checkNotNull(rate, "rate");
        this.rate = Optional.ofNullable(rate);
        return this;
    }

    public InstantTransactionCreateResponse withRate(Optional<? extends InstantTransactionRate> rate) {
        Utils.checkNotNull(rate, "rate");
        this.rate = rate;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InstantTransactionCreateResponse other = (InstantTransactionCreateResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(InstantTransactionCreateResponse.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<InstantTransactionCreateResponseMessages>> messages = Optional.empty();
        ...
        private Optional<? extends InstantTransactionRate> rate = Optional.empty();  
         ...
         * `message` (string): a publishable message containing further information.
         */
        public Builder messages(java.util.List<InstantTransactionCreateResponseMessages> messages) {
            Utils.checkNotNull(messages, "messages");
            this.messages = Optional.ofNullable(messages);
            return this;
        }
         ...
         * `message` (string): a publishable message containing further information.
         */
        public Builder messages(Optional<? extends java.util.List<InstantTransactionCreateResponseMessages>> messages) {
            Utils.checkNotNull(messages, "messages");
            this.messages = messages;
            return this;
        }
        ...
        public Builder rate(InstantTransactionRate rate) {
            Utils.checkNotNull(rate, "rate");
            this.rate = Optional.ofNullable(rate);
            return this;
        }

        public Builder rate(Optional<? extends InstantTransactionRate> rate) {
            Utils.checkNotNull(rate, "rate");
            this.rate = rate;
            return this;
        }
        
        public InstantTransactionCreateResponse build() {
            return new InstantTransactionCreateResponse(
                commercialInvoiceUrl,
                eta,
                labelFileType,
                labelUrl,
