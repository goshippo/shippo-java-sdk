...
public class CustomsInvoicedCharges {
     ...
     */
    @JsonIgnore
    public Optional<? extends String> totalShipping() {
     ...
     */
    @JsonIgnore
    public Optional<? extends String> totalTaxes() {
        return totalTaxes;
    }
     ...
     */
    @JsonIgnore
    public Optional<? extends String> totalDuties() {
        return totalDuties;
    }
     ...
     */
    @JsonIgnore
    public Optional<? extends String> otherFees() {
        return otherFees;
    }
