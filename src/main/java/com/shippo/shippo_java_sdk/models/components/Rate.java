...
public class Rate {
    ...
    private Optional<? extends java.util.List<RateMessage>> messages;
    ...
    public Rate(
            ...
            @JsonProperty("messages") Optional<? extends java.util.List<RateMessage>> messages,
     ...
     */
    @JsonIgnore
    public Optional<? extends String> arrivesBy() {
        return arrivesBy;
    }
     ...
     */
    @JsonIgnore
    public Optional<? extends String> durationTerms() {
     ...
     */
    @JsonIgnore
    public Optional<? extends Double> includedInsurancePrice() {
     ...
     */
    @JsonIgnore
    public Optional<? extends java.util.List<RateMessage>> messages() {
        return messages;
    }
     ...
     */
    @JsonIgnore
    public Optional<? extends String> providerImage75() {
     ...
     */
    @JsonIgnore
    public Optional<? extends String> providerImage200() {
     ...
     * `text` (string): a publishable message containing further information (not always available).
     */
    public Rate withMessages(java.util.List<RateMessage> messages) {
        Utils.checkNotNull(messages, "messages");
     ...
     * `text` (string): a publishable message containing further information (not always available).
     */
    public Rate withMessages(Optional<? extends java.util.List<RateMessage>> messages) {
        Utils.checkNotNull(messages, "messages");
        this.messages = messages;
        return this;
    }
     ...
     * Contains details regarding the service level for the given rate.
     */
    public Rate withServicelevel(ServiceLevel servicelevel) {
        Utils.checkNotNull(servicelevel, "servicelevel");
        this.servicelevel = servicelevel;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<RateMessage>> messages = Optional.empty();
         ...
         * `text` (string): a publishable message containing further information (not always available).
         */
        public Builder messages(java.util.List<RateMessage> messages) {
            Utils.checkNotNull(messages, "messages");
            this.messages = Optional.ofNullable(messages);
            return this;
        }
         ...
         * `text` (string): a publishable message containing further information (not always available).
         */
        public Builder messages(Optional<? extends java.util.List<RateMessage>> messages) {
            Utils.checkNotNull(messages, "messages");
            this.messages = messages;
            return this;
        }
