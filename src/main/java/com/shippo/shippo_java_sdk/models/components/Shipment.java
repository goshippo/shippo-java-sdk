...
public class Shipment {
    ...
    public Shipment(
            ...
            @JsonProperty("messages") java.util.List<Messages> messages,
    ...
    public Shipment(
        ...
        this(Optional.empty(), Optional.empty(), metadata, Optional.empty(), addressFrom, Optional.empty(), addressTo, carrierAccounts, messages, objectCreated, objectId, objectOwner, objectUpdated, parcels, rates, status, Optional.empty());
    }
     ...
     */
    @JsonIgnore
    public Optional<? extends Address> addressReturn() {
     ...
     */
    @JsonIgnore
    public java.util.List<Messages> messages() {
        return messages;
    }
     ...
     * ID of the Customs Declarations object for an international shipment.
     */
    public Shipment withCustomsDeclaration(String customsDeclaration) {
        Utils.checkNotNull(customsDeclaration, "customsDeclaration");
     ...
     * ID of the Customs Declarations object for an international shipment.
     */
    public Shipment withCustomsDeclaration(Optional<? extends String> customsDeclaration) {
        Utils.checkNotNull(customsDeclaration, "customsDeclaration");
        this.customsDeclaration = customsDeclaration;
        return this;
    }
     ...
     * (not always available)&lt;br&gt;`message` (string): a publishable message containing further information.
     */
    public Shipment withMessages(java.util.List<Messages> messages) {
        Utils.checkNotNull(messages, "messages");
        this.messages = messages;
        return this;
    }
