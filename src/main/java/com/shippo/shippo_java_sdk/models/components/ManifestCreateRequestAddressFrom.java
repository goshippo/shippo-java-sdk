...
public class ManifestCreateRequestAddressFrom {
    ...
    public static final class _Deserializer extends com.shippo.shippo_java_sdk.utils.OneOfDeserializer<ManifestCreateRequestAddressFrom> {

        public _Deserializer() {
            super(ManifestCreateRequestAddressFrom.class,
