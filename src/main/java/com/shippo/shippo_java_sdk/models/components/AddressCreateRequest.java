...
public class AddressCreateRequest {
    ...
    public AddressCreateRequest(
            String country) {
        this(Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), country, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    }
     ...
     * Latitude of address
     */
    public AddressCreateRequest withLatitude(double latitude) {
        Utils.checkNotNull(latitude, "latitude");
     ...
     * Latitude of address
     */
    public AddressCreateRequest withLatitude(Optional<? extends Double> latitude) {
        Utils.checkNotNull(latitude, "latitude");
        this.latitude = latitude;
        return this;
    }
     ...
     * Longitude of address
     */
    public AddressCreateRequest withLongitude(double longitude) {
        Utils.checkNotNull(longitude, "longitude");
     ...
     * Longitude of address
     */
    public AddressCreateRequest withLongitude(Optional<? extends Double> longitude) {
        Utils.checkNotNull(longitude, "longitude");
        this.longitude = longitude;
        return this;
    }
