...
public class Pickup {
    ...
    public Optional<String> confirmedStartTime() {
        return (Optional<String>) confirmedStartTime;
    }
    ...
    public Optional<String> confirmedEndTime() {
        return (Optional<String>) confirmedEndTime;
    }
    ...
    public Optional<String> cancelByTime() {
        return (Optional<String>) cancelByTime;
    }
    ...
    public Optional<String> confirmationCode() {
        return (Optional<String>) confirmationCode;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<String>> messages() {
        return (Optional<java.util.List<String>>) messages;
    }
