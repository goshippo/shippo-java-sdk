...
public class UPSConnectExistingOwnAccountParameters {
    ...
    public Optional<String> aiaCountryIso2() {
        return (Optional<String>) aiaCountryIso2;
    }
    ...
    public Optional<String> currencyCode() {
        return (Optional<String>) currencyCode;
    }
    ...
    public Optional<String> invoiceControlid() {
        return (Optional<String>) invoiceControlid;
    }
    ...
    public Optional<String> invoiceDate() {
        return (Optional<String>) invoiceDate;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<String> invoiceNumber() {
        return (Optional<String>) invoiceNumber;
    }
    ...
    public Optional<String> invoiceValue() {
        return (Optional<String>) invoiceValue;
    }
