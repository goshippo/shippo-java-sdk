...
public class BatchShipmentPaginatedList {
    ...
    private Optional<? extends java.util.List<BatchShipment>> results;
    ...
    public BatchShipmentPaginatedList(
            ...
            @JsonProperty("results") Optional<? extends java.util.List<BatchShipment>> results) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<BatchShipment>> results() {
        return (Optional<java.util.List<BatchShipment>>) results;
    }
    ...
    public BatchShipmentPaginatedList withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public BatchShipmentPaginatedList withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }

    public BatchShipmentPaginatedList withResults(java.util.List<BatchShipment> results) {
        Utils.checkNotNull(results, "results");
        this.results = Optional.ofNullable(results);
        return this;
    }

    public BatchShipmentPaginatedList withResults(Optional<? extends java.util.List<BatchShipment>> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<BatchShipment>> results = Optional.empty();  
        ...
        public Builder results(java.util.List<BatchShipment> results) {
            Utils.checkNotNull(results, "results");
            this.results = Optional.ofNullable(results);
            return this;
        }

        public Builder results(Optional<? extends java.util.List<BatchShipment>> results) {
            Utils.checkNotNull(results, "results");
            this.results = results;
            return this;
        }
