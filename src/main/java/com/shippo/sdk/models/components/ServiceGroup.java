...
public class ServiceGroup {
    ...
    private java.util.List<ServiceLevelWithParent> serviceLevels;
    ...
    public ServiceGroup(
            ...
            @JsonProperty("is_active") Optional<? extends Boolean> isActive,
            @JsonProperty("service_levels") java.util.List<ServiceLevelWithParent> serviceLevels) {
    ...
    public ServiceGroup(
            ...
            String objectId,
            java.util.List<ServiceLevelWithParent> serviceLevels) {
    ...
    @JsonIgnore
    public java.util.List<ServiceLevelWithParent> serviceLevels() {
     ...
     * `FREE_SHIPPING`
     */
    public ServiceGroup withFlatRate(Optional<? extends String> flatRate) {
        Utils.checkNotNull(flatRate, "flatRate");
        this.flatRate = flatRate;
        return this;
    }
     ...
     * required unless type is `FREE_SHIPPING`. (ISO 4217 currency)
     */
    public ServiceGroup withFlatRateCurrency(Optional<? extends String> flatRateCurrency) {
        Utils.checkNotNull(flatRateCurrency, "flatRateCurrency");
        this.flatRateCurrency = flatRateCurrency;
        return this;
    }
     ...
     * optional unless type is `FREE_SHIPPING`. (ISO 4217 currency)
     */
    public ServiceGroup withFreeShippingThresholdCurrency(Optional<? extends String> freeShippingThresholdCurrency) {
        Utils.checkNotNull(freeShippingThresholdCurrency, "freeShippingThresholdCurrency");
        this.freeShippingThresholdCurrency = freeShippingThresholdCurrency;
        return this;
    }
     ...
     * The amount in percent (%) that the service group's returned rate should be adjusted. For example, if this field is set to 5 and the matched rate price is $5.00, the returned value of the service group will be $5.25. Negative integers are also accepted and will discount the rate price by the defined percentage amount.
     */
    public ServiceGroup withRateAdjustment(Optional<? extends Long> rateAdjustment) {
        Utils.checkNotNull(rateAdjustment, "rateAdjustment");
        this.rateAdjustment = rateAdjustment;
        return this;
    }
     ...
     * True if the service group is enabled, false otherwise.
     */
    public ServiceGroup withIsActive(Optional<? extends Boolean> isActive) {
        Utils.checkNotNull(isActive, "isActive");
        this.isActive = isActive;
        return this;
    }

    public ServiceGroup withServiceLevels(java.util.List<ServiceLevelWithParent> serviceLevels) {
        Utils.checkNotNull(serviceLevels, "serviceLevels");
        this.serviceLevels = serviceLevels;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder serviceLevels(java.util.List<ServiceLevelWithParent> serviceLevels) {
            Utils.checkNotNull(serviceLevels, "serviceLevels");
            this.serviceLevels = serviceLevels;
            return this;
        }
