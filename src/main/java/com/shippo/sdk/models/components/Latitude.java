...
public class Latitude {
    ...
    public static Latitude of(double value) {
        ...
        return new Latitude(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<Double>(){}));
    }
    ...
    public static final class _Deserializer extends com.shippo.sdk.utils.OneOfDeserializer<Latitude> {
