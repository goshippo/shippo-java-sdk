...
public class CarrierAccountUPSCreateRequestParameters {
    ...
    private Optional<? extends Boolean> pickupAddressSameAsBillingAddress;
    ...
    private Optional<? extends String> pickupAddressStreet2;
    ...
    public CarrierAccountUPSCreateRequestParameters(
            ...
            @JsonProperty("full_name") Optional<? extends String> fullName,
            ...
            @JsonProperty("pickup_address_same_as_billing_address") Optional<? extends Boolean> pickupAddressSameAsBillingAddress,
            ...
            @JsonProperty("pickup_address_street2") Optional<? extends String> pickupAddressStreet2,
    ...
    public Optional<String> billingAddressStreet2() {
        return (Optional<String>) billingAddressStreet2;
    }
    ...
    public Optional<Boolean> pickupAddressSameAsBillingAddress() {
        return (Optional<Boolean>) pickupAddressSameAsBillingAddress;
    }
    ...
    public Optional<String> pickupAddressStreet2() {
        return (Optional<String>) pickupAddressStreet2;
    }
     ...
     * Empty string acceptable for billing_address_street2
     */
    public CarrierAccountUPSCreateRequestParameters withBillingAddressStreet2(Optional<? extends String> billingAddressStreet2) {
        Utils.checkNotNull(billingAddressStreet2, "billingAddressStreet2");
        this.billingAddressStreet2 = billingAddressStreet2;
        return this;
    }
     ...
     * Company name. Full name is acceptable in this field if the user has no company name
     */
    public CarrierAccountUPSCreateRequestParameters withCompany(Optional<? extends String> company) {
        Utils.checkNotNull(company, "company");
        this.company = company;
        return this;
    }
    ...
    public CarrierAccountUPSCreateRequestParameters withEmail(Optional<? extends String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
    ...
    public CarrierAccountUPSCreateRequestParameters withFullName(Optional<? extends String> fullName) {
        Utils.checkNotNull(fullName, "fullName");
        this.fullName = fullName;
        return this;
    }
     ...
     * Needs to be a valid phone number and cannot be null
     */
    public CarrierAccountUPSCreateRequestParameters withPhone(Optional<? extends String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
    ...
    public CarrierAccountUPSCreateRequestParameters withPickupAddressSameAsBillingAddress(Optional<? extends Boolean> pickupAddressSameAsBillingAddress) {
        Utils.checkNotNull(pickupAddressSameAsBillingAddress, "pickupAddressSameAsBillingAddress");
        this.pickupAddressSameAsBillingAddress = pickupAddressSameAsBillingAddress;
        return this;
    }
     ...
     * User's pickup street 2.
     */
    public CarrierAccountUPSCreateRequestParameters withPickupAddressStreet2(Optional<? extends String> pickupAddressStreet2) {
        Utils.checkNotNull(pickupAddressStreet2, "pickupAddressStreet2");
        this.pickupAddressStreet2 = pickupAddressStreet2;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            java.util.Objects.deepEquals(this.pickupAddressCity, other.pickupAddressCity) &&
            java.util.Objects.deepEquals(this.pickupAddressCountryIso2, other.pickupAddressCountryIso2) &&
            java.util.Objects.deepEquals(this.pickupAddressSameAsBillingAddress, other.pickupAddressSameAsBillingAddress) &&
            java.util.Objects.deepEquals(this.pickupAddressState, other.pickupAddressState) &&
            java.util.Objects.deepEquals(this.pickupAddressStreet1, other.pickupAddressStreet1) &&
            java.util.Objects.deepEquals(this.pickupAddressStreet2, other.pickupAddressStreet2) &&
            java.util.Objects.deepEquals(this.pickupAddressZip, other.pickupAddressZip) &&
    ...
    public final static class Builder {
        ...
        private Optional<? extends Boolean> pickupAddressSameAsBillingAddress = Optional.empty();
 
        private String pickupAddressState;
 
        private String pickupAddressStreet1;
 
        private Optional<? extends String> pickupAddressStreet2 = Optional.empty();
        ...
        public Builder pickupAddressSameAsBillingAddress(Optional<? extends Boolean> pickupAddressSameAsBillingAddress) {
            Utils.checkNotNull(pickupAddressSameAsBillingAddress, "pickupAddressSameAsBillingAddress");
            this.pickupAddressSameAsBillingAddress = pickupAddressSameAsBillingAddress;
            return this;
        }
         ...
         * User's pickup street 2.
         */
        public Builder pickupAddressStreet2(Optional<? extends String> pickupAddressStreet2) {
            Utils.checkNotNull(pickupAddressStreet2, "pickupAddressStreet2");
            this.pickupAddressStreet2 = pickupAddressStreet2;
            return this;
        }
