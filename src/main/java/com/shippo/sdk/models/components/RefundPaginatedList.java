...
public class RefundPaginatedList {
    ...
    private Optional<? extends java.util.List<Refund>> results;
    ...
    public RefundPaginatedList(
            ...
            @JsonProperty("results") Optional<? extends java.util.List<Refund>> results) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<Refund>> results() {
        return (Optional<java.util.List<Refund>>) results;
    }
    ...
    public RefundPaginatedList withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public RefundPaginatedList withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }

    public RefundPaginatedList withResults(java.util.List<Refund> results) {
        Utils.checkNotNull(results, "results");
        this.results = Optional.ofNullable(results);
        return this;
    }

    public RefundPaginatedList withResults(Optional<? extends java.util.List<Refund>> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<Refund>> results = Optional.empty();  
        ...
        public Builder results(java.util.List<Refund> results) {
            Utils.checkNotNull(results, "results");
            this.results = Optional.ofNullable(results);
            return this;
        }

        public Builder results(Optional<? extends java.util.List<Refund>> results) {
            Utils.checkNotNull(results, "results");
            this.results = results;
            return this;
        }
