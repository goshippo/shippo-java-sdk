...
public class LiveRatePaginatedList {
    ...
    private Optional<? extends List<LiveRate>> results;
    ...
    public LiveRatePaginatedList(
            ...
            @JsonProperty("results") Optional<? extends List<LiveRate>> results) {
    ...
    @JsonIgnore
    public Optional<List<LiveRate>> results() {
        return (Optional<List<LiveRate>>) results;
    }
    ...
    public LiveRatePaginatedList withNext(Optional<String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public LiveRatePaginatedList withPrevious(Optional<String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }
    ...
    public LiveRatePaginatedList withCount(Optional<Long> count) {
        Utils.checkNotNull(count, "count");
        this.count = count;
        return this;
    }

    public LiveRatePaginatedList withResults(List<LiveRate> results) {
        Utils.checkNotNull(results, "results");
        this.results = Optional.ofNullable(results);
        return this;
    }

    public LiveRatePaginatedList withResults(Optional<? extends List<LiveRate>> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<LiveRate>> results = Optional.empty();  
        ...
        public Builder results(List<LiveRate> results) {
            Utils.checkNotNull(results, "results");
            this.results = Optional.ofNullable(results);
            return this;
        }

        public Builder results(Optional<? extends List<LiveRate>> results) {
            Utils.checkNotNull(results, "results");
            this.results = results;
            return this;
        }
