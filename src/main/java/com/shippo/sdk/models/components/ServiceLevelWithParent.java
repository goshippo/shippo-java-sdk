...
public class ServiceLevelWithParent {
    ...
    private Optional<? extends ParentServicelevel> parentServicelevel;
    ...
    public ServiceLevelWithParent(
            ...
            @JsonProperty("parent_servicelevel") Optional<? extends ParentServicelevel> parentServicelevel) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<ParentServicelevel> parentServicelevel() {
        return (Optional<ParentServicelevel>) parentServicelevel;
    }
     ...
     * These names vary depending on the provider.
     */
    public ServiceLevelWithParent withName(Optional<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Further clarification of the service.
     */
    public ServiceLevelWithParent withTerms(Optional<? extends String> terms) {
        Utils.checkNotNull(terms, "terms");
        this.terms = terms;
        return this;
    }
     ...
     * See &lt;a href="#tag/Service-Levels"&gt;servicelevels&lt;/a&gt;.
     */
    public ServiceLevelWithParent withToken(Optional<? extends String> token) {
        Utils.checkNotNull(token, "token");
        this.token = token;
        return this;
    }
     ...
     * Guaranteed to be unique across all Service Levels, and may help offer insight into the specific Service Level it describes.
     */
    public ServiceLevelWithParent withExtendedToken(Optional<? extends String> extendedToken) {
        Utils.checkNotNull(extendedToken, "extendedToken");
        this.extendedToken = extendedToken;
        return this;
    }

    public ServiceLevelWithParent withParentServicelevel(ParentServicelevel parentServicelevel) {
        Utils.checkNotNull(parentServicelevel, "parentServicelevel");
        this.parentServicelevel = Optional.ofNullable(parentServicelevel);
        return this;
    }

    public ServiceLevelWithParent withParentServicelevel(Optional<? extends ParentServicelevel> parentServicelevel) {
        Utils.checkNotNull(parentServicelevel, "parentServicelevel");
        this.parentServicelevel = parentServicelevel;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends ParentServicelevel> parentServicelevel = Optional.empty();  
        ...
        public Builder parentServicelevel(ParentServicelevel parentServicelevel) {
            Utils.checkNotNull(parentServicelevel, "parentServicelevel");
            this.parentServicelevel = Optional.ofNullable(parentServicelevel);
            return this;
        }

        public Builder parentServicelevel(Optional<? extends ParentServicelevel> parentServicelevel) {
            Utils.checkNotNull(parentServicelevel, "parentServicelevel");
            this.parentServicelevel = parentServicelevel;
            return this;
        }
