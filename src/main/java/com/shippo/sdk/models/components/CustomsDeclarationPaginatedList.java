...
public class CustomsDeclarationPaginatedList {
    ...
    private Optional<? extends java.util.List<CustomsDeclaration>> results;
    ...
    public CustomsDeclarationPaginatedList(
            ...
            @JsonProperty("results") Optional<? extends java.util.List<CustomsDeclaration>> results) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<CustomsDeclaration>> results() {
        return (Optional<java.util.List<CustomsDeclaration>>) results;
    }
    ...
    public CustomsDeclarationPaginatedList withNext(Optional<? extends String> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public CustomsDeclarationPaginatedList withPrevious(Optional<? extends String> previous) {
        Utils.checkNotNull(previous, "previous");
        this.previous = previous;
        return this;
    }

    public CustomsDeclarationPaginatedList withResults(java.util.List<CustomsDeclaration> results) {
        Utils.checkNotNull(results, "results");
        this.results = Optional.ofNullable(results);
        return this;
    }

    public CustomsDeclarationPaginatedList withResults(Optional<? extends java.util.List<CustomsDeclaration>> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<CustomsDeclaration>> results = Optional.empty();  
        ...
        public Builder results(java.util.List<CustomsDeclaration> results) {
            Utils.checkNotNull(results, "results");
            this.results = Optional.ofNullable(results);
            return this;
        }

        public Builder results(Optional<? extends java.util.List<CustomsDeclaration>> results) {
            Utils.checkNotNull(results, "results");
            this.results = results;
            return this;
        }
