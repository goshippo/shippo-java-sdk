...
public class InstantTransactionCreateRequest {
    ...
    public InstantTransactionCreateRequest withAsync(Optional<? extends Boolean> async) {
        Utils.checkNotNull(async, "async");
        this.async = async;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private static final LazySingletonValue<Optional<? extends Boolean>> _SINGLETON_VALUE_Async =
