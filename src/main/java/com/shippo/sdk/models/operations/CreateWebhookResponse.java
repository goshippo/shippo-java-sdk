...
public class CreateWebhookResponse implements com.shippo.sdk.utils.Response {
    ...
    public CreateWebhookResponse withWebhook(com.shippo.sdk.models.components.Webhook webhook) {
        Utils.checkNotNull(webhook, "webhook");
        this.webhook = Optional.ofNullable(webhook);
        return this;
    }

    public CreateWebhookResponse withWebhook(Optional<? extends com.shippo.sdk.models.components.Webhook> webhook) {
        Utils.checkNotNull(webhook, "webhook");
        this.webhook = webhook;
        return this;
    }
