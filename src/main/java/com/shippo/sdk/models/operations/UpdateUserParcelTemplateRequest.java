...
public class UpdateUserParcelTemplateRequest {
    ...
    private Optional<? extends com.shippo.sdk.models.components.UserParcelTemplateUpdateRequest> userParcelTemplateUpdateRequest;

    @JsonCreator
    public UpdateUserParcelTemplateRequest(
            String userParcelTemplateObjectId,
            Optional<? extends String> shippoApiVersion,
            Optional<? extends com.shippo.sdk.models.components.UserParcelTemplateUpdateRequest> userParcelTemplateUpdateRequest) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<com.shippo.sdk.models.components.UserParcelTemplateUpdateRequest> userParcelTemplateUpdateRequest() {
        return (Optional<com.shippo.sdk.models.components.UserParcelTemplateUpdateRequest>) userParcelTemplateUpdateRequest;
    }
    ...
    public UpdateUserParcelTemplateRequest withUserParcelTemplateUpdateRequest(com.shippo.sdk.models.components.UserParcelTemplateUpdateRequest userParcelTemplateUpdateRequest) {
        Utils.checkNotNull(userParcelTemplateUpdateRequest, "userParcelTemplateUpdateRequest");
        this.userParcelTemplateUpdateRequest = Optional.ofNullable(userParcelTemplateUpdateRequest);
        return this;
    }

    public UpdateUserParcelTemplateRequest withUserParcelTemplateUpdateRequest(Optional<? extends com.shippo.sdk.models.components.UserParcelTemplateUpdateRequest> userParcelTemplateUpdateRequest) {
        Utils.checkNotNull(userParcelTemplateUpdateRequest, "userParcelTemplateUpdateRequest");
        this.userParcelTemplateUpdateRequest = userParcelTemplateUpdateRequest;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends com.shippo.sdk.models.components.UserParcelTemplateUpdateRequest> userParcelTemplateUpdateRequest = Optional.empty();  
        ...
        public Builder userParcelTemplateUpdateRequest(com.shippo.sdk.models.components.UserParcelTemplateUpdateRequest userParcelTemplateUpdateRequest) {
            Utils.checkNotNull(userParcelTemplateUpdateRequest, "userParcelTemplateUpdateRequest");
            this.userParcelTemplateUpdateRequest = Optional.ofNullable(userParcelTemplateUpdateRequest);
            return this;
        }

        public Builder userParcelTemplateUpdateRequest(Optional<? extends com.shippo.sdk.models.components.UserParcelTemplateUpdateRequest> userParcelTemplateUpdateRequest) {
            Utils.checkNotNull(userParcelTemplateUpdateRequest, "userParcelTemplateUpdateRequest");
            this.userParcelTemplateUpdateRequest = userParcelTemplateUpdateRequest;
            return this;
        }
