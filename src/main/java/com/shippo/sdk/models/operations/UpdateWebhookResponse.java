...
public class UpdateWebhookResponse implements com.shippo.sdk.utils.Response {
    ...
    public UpdateWebhookResponse withWebhook(com.shippo.sdk.models.components.Webhook webhook) {
        Utils.checkNotNull(webhook, "webhook");
        this.webhook = Optional.ofNullable(webhook);
        return this;
    }

    public UpdateWebhookResponse withWebhook(Optional<? extends com.shippo.sdk.models.components.Webhook> webhook) {
        Utils.checkNotNull(webhook, "webhook");
        this.webhook = webhook;
        return this;
    }
