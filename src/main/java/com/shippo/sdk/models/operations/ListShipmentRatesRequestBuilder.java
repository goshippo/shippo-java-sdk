...
public class ListShipmentRatesRequestBuilder {
    ...
    public ListShipmentRatesRequestBuilder page(Optional<? extends Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
    ...
    public ListShipmentRatesRequestBuilder results(Optional<? extends Long> results) {
        Utils.checkNotNull(results, "results");
    ...
    public ListShipmentRatesRequestBuilder shippoApiVersion(Optional<? extends String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
