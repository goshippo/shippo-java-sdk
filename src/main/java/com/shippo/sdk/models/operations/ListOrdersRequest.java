...
public class ListOrdersRequest {
     ...
     * The page number you want to select
     */
    public ListOrdersRequest withPage(Optional<? extends Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The number of results to return per page (max 100)
     */
    public ListOrdersRequest withResults(Optional<? extends Long> results) {
        Utils.checkNotNull(results, "results");
        this.results = results;
        return this;
    }
     ...
     * String used to pick a non-default API version to use
     */
    public ListOrdersRequest withShippoApiVersion(Optional<? extends String> shippoApiVersion) {
        Utils.checkNotNull(shippoApiVersion, "shippoApiVersion");
        this.shippoApiVersion = shippoApiVersion;
        return this;
    }
