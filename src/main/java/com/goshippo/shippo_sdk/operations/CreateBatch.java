...
public class CreateBatch {
    ...
    public static class Sync extends Base
            implements RequestOperation<BatchCreateRequest, CreateBatchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(BatchCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BatchCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BatchCreateRequest request) {
        ...
        @Override
        public CreateBatchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateBatchResponse.Builder resBuilder =
                    CreateBatchResponse
                            .builder()
            ...
            CreateBatchResponse res = resBuilder.build();
