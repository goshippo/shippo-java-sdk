...
public class GetManifest {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetManifestRequest, GetManifestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetManifestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetManifestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetManifestRequest request) {
        ...
        @Override
        public GetManifestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetManifestResponse.Builder resBuilder =
                    GetManifestResponse
                            .builder()
            ...
            GetManifestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withManifest(Utils.unmarshal(response, new TypeReference<Manifest>() {}));
                } else {
