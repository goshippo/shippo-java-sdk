...
public class ListCarrierAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCarrierAccountsRequest, ListCarrierAccountsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCarrierAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCarrierAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCarrierAccountsRequest request) {
        ...
        @Override
        public ListCarrierAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCarrierAccountsResponse.Builder resBuilder =
            ...
            ListCarrierAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCarrierAccountPaginatedList(Utils.unmarshal(response, new TypeReference<CarrierAccountPaginatedList>() {}));
                } else {
