...
public class CreatePickup {
    ...
    public static class Sync extends Base
            implements RequestOperation<PickupBase, CreatePickupResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PickupBase request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PickupBase>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PickupBase request) {
        ...
        @Override
        public CreatePickupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePickupResponse.Builder resBuilder =
            ...
            CreatePickupResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPickup(Utils.unmarshal(response, new TypeReference<Pickup>() {}));
                } else {
