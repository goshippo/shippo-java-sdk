...
public class RemoveShipmentsFromBatch {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveShipmentsFromBatchRequest, RemoveShipmentsFromBatchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveShipmentsFromBatchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveShipmentsFromBatchRequest.class, new TypeReference<RemoveShipmentsFromBatchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveShipmentsFromBatchRequest request) {
        ...
        @Override
        public RemoveShipmentsFromBatchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveShipmentsFromBatchResponse.Builder resBuilder =
            ...
            RemoveShipmentsFromBatchResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBatch(Utils.unmarshal(response, new TypeReference<Batch>() {}));
                } else {
