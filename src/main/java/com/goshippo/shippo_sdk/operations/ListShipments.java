...
public class ListShipments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShipmentsRequest, ListShipmentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShipmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShipmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShipmentsRequest request) {
        ...
        @Override
        public ListShipmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShipmentsResponse.Builder resBuilder =
            ...
            ListShipmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShipmentPaginatedList(Utils.unmarshal(response, new TypeReference<ShipmentPaginatedList>() {}));
                } else {
