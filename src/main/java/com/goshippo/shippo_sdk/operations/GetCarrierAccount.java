...
public class GetCarrierAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCarrierAccountRequest, GetCarrierAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCarrierAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCarrierAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCarrierAccountRequest request) {
        ...
        @Override
        public GetCarrierAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCarrierAccountResponse.Builder resBuilder =
            ...
            GetCarrierAccountResponse res = resBuilder.build();
