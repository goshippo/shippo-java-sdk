...
public class DeleteDefaultParcelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDefaultParcelTemplateRequest, DeleteDefaultParcelTemplateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteDefaultParcelTemplateRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDefaultParcelTemplateRequest request) {
        ...
        @Override
        public DeleteDefaultParcelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDefaultParcelTemplateResponse.Builder resBuilder =
            ...
            DeleteDefaultParcelTemplateResponse res = resBuilder.build();
