...
public class CreateUserParcelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<UserParcelTemplateCreateRequest, CreateUserParcelTemplateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UserParcelTemplateCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UserParcelTemplateCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UserParcelTemplateCreateRequest request) {
        ...
        @Override
        public CreateUserParcelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUserParcelTemplateResponse.Builder resBuilder =
            ...
            CreateUserParcelTemplateResponse res = resBuilder.build();
