...
public class CreateTransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTransactionRequestBody, CreateTransactionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTransactionRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateTransactionRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTransactionRequestBody request) {
