...
public class GetCustomsDeclaration {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCustomsDeclarationRequest, GetCustomsDeclarationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCustomsDeclarationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCustomsDeclarationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCustomsDeclarationRequest request) {
        ...
        @Override
        public GetCustomsDeclarationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCustomsDeclarationResponse.Builder resBuilder =
            ...
            GetCustomsDeclarationResponse res = resBuilder.build();
