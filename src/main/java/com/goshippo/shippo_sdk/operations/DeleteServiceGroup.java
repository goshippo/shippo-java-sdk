...
public class DeleteServiceGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteServiceGroupRequest, DeleteServiceGroupResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteServiceGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteServiceGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteServiceGroupRequest request) {
        ...
        @Override
        public DeleteServiceGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteServiceGroupResponse.Builder resBuilder =
            ...
            DeleteServiceGroupResponse res = resBuilder.build();
