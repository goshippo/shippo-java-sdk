...
public class CreateOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<OrderCreateRequest, CreateOrderResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(OrderCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<OrderCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(OrderCreateRequest request) {
        ...
        @Override
        public CreateOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateOrderResponse.Builder resBuilder =
                    CreateOrderResponse
                            .builder()
            ...
            CreateOrderResponse res = resBuilder.build();
