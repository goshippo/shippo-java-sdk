...
public class CreateLiveRate {
    ...
    public static class Sync extends Base
            implements RequestOperation<LiveRateCreateRequest, CreateLiveRateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(LiveRateCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<LiveRateCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LiveRateCreateRequest request) {
        ...
        @Override
        public CreateLiveRateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLiveRateResponse.Builder resBuilder =
            ...
            CreateLiveRateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLiveRatePaginatedList(Utils.unmarshal(response, new TypeReference<LiveRatePaginatedList>() {}));
                } else {
