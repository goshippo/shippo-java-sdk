...
public class UpdateDefaultParcelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<DefaultParcelTemplateUpdateRequest, UpdateDefaultParcelTemplateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DefaultParcelTemplateUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DefaultParcelTemplateUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DefaultParcelTemplateUpdateRequest request) {
        ...
        @Override
        public UpdateDefaultParcelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDefaultParcelTemplateResponse.Builder resBuilder =
            ...
            UpdateDefaultParcelTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDefaultParcelTemplate(Utils.unmarshal(response, new TypeReference<DefaultParcelTemplate>() {}));
                } else {
