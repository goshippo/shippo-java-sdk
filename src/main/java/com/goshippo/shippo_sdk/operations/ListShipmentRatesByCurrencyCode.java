...
public class ListShipmentRatesByCurrencyCode {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShipmentRatesByCurrencyCodeRequest, ListShipmentRatesByCurrencyCodeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShipmentRatesByCurrencyCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShipmentRatesByCurrencyCodeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShipmentRatesByCurrencyCodeRequest request) {
        ...
        @Override
        public ListShipmentRatesByCurrencyCodeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShipmentRatesByCurrencyCodeResponse.Builder resBuilder =
            ...
            ListShipmentRatesByCurrencyCodeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRatePaginatedList(Utils.unmarshal(response, new TypeReference<RatePaginatedList>() {}));
                } else {
