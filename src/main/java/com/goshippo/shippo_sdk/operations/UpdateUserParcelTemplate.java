...
public class UpdateUserParcelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUserParcelTemplateRequest, UpdateUserParcelTemplateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateUserParcelTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUserParcelTemplateRequest.class, new TypeReference<UpdateUserParcelTemplateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUserParcelTemplateRequest request) {
        ...
        @Override
        public UpdateUserParcelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUserParcelTemplateResponse.Builder resBuilder =
            ...
            UpdateUserParcelTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUserParcelTemplate(Utils.unmarshal(response, new TypeReference<UserParcelTemplate>() {}));
                } else {
