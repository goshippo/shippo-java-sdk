...
public class AddShipmentsToBatch {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddShipmentsToBatchRequest, AddShipmentsToBatchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddShipmentsToBatchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddShipmentsToBatchRequest.class, new TypeReference<AddShipmentsToBatchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddShipmentsToBatchRequest request) {
        ...
        @Override
        public AddShipmentsToBatchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddShipmentsToBatchResponse.Builder resBuilder =
            ...
            AddShipmentsToBatchResponse res = resBuilder.build();
