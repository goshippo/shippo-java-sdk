...
public class CreateServiceGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<ServiceGroupCreateRequest, CreateServiceGroupResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ServiceGroupCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ServiceGroupCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ServiceGroupCreateRequest request) {
        ...
        @Override
        public CreateServiceGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateServiceGroupResponse.Builder resBuilder =
            ...
            CreateServiceGroupResponse res = resBuilder.build();
