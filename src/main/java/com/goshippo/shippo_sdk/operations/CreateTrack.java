...
public class CreateTrack {
    ...
    public static class Sync extends Base
            implements RequestOperation<TracksRequest, CreateTrackResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(TracksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<TracksRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TracksRequest request) {
        ...
        @Override
        public CreateTrackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTrackResponse.Builder resBuilder =
                    CreateTrackResponse
                            .builder()
            ...
            CreateTrackResponse res = resBuilder.build();
