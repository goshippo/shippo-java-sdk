...
public class InitiateOauth2Signin {
    ...
    public static class Sync extends Base
            implements RequestOperation<InitiateOauth2SigninRequest, InitiateOauth2SigninResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(InitiateOauth2SigninRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InitiateOauth2SigninRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InitiateOauth2SigninRequest request) {
        ...
        @Override
        public InitiateOauth2SigninResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            InitiateOauth2SigninResponse.Builder resBuilder =
            ...
            InitiateOauth2SigninResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw InitiateOauth2SigninResponseBody.from(response);
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw InitiateOauth2SigninCarrierAccountsResponseResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw InitiateOauth2SigninCarrierAccountsResponseBody.from(response);
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
