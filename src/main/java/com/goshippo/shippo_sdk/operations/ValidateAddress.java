...
public class ValidateAddress {
    ...
    public static class Sync extends Base
            implements RequestOperation<ValidateAddressRequest, ValidateAddressResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ValidateAddressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ValidateAddressRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ValidateAddressRequest request) {
        ...
        @Override
        public ValidateAddressResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ValidateAddressResponse.Builder resBuilder =
            ...
            ValidateAddressResponse res = resBuilder.build();
