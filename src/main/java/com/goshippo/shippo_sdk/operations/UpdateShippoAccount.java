...
import com.goshippo.shippo_sdk.models.components.ShippoAccount;
...
public class UpdateShippoAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateShippoAccountRequest, UpdateShippoAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateShippoAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateShippoAccountRequest.class, new TypeReference<UpdateShippoAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateShippoAccountRequest request) {
        ...
        @Override
        public UpdateShippoAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateShippoAccountResponse.Builder resBuilder =
            ...
            UpdateShippoAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippoAccount(Utils.unmarshal(response, new TypeReference<ShippoAccount>() {}));
                } else {
