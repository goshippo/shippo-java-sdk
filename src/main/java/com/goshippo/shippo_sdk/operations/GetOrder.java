...
public class GetOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrderRequest, GetOrderResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrderRequest request) {
        ...
        @Override
        public GetOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOrderResponse.Builder resBuilder =
                    GetOrderResponse
                            .builder()
            ...
            GetOrderResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrder(Utils.unmarshal(response, new TypeReference<Order>() {}));
                } else {
