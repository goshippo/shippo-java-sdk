...
public class GetCarrierParcelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCarrierParcelTemplateRequest, GetCarrierParcelTemplateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCarrierParcelTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCarrierParcelTemplateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCarrierParcelTemplateRequest request) {
        ...
        @Override
        public GetCarrierParcelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCarrierParcelTemplateResponse.Builder resBuilder =
            ...
            GetCarrierParcelTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCarrierParcelTemplate(Utils.unmarshal(response, new TypeReference<CarrierParcelTemplate>() {}));
                } else {
