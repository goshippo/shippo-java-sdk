...
public class GetUserParcelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUserParcelTemplateRequest, GetUserParcelTemplateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUserParcelTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUserParcelTemplateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUserParcelTemplateRequest request) {
        ...
        @Override
        public GetUserParcelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUserParcelTemplateResponse.Builder resBuilder =
            ...
            GetUserParcelTemplateResponse res = resBuilder.build();
