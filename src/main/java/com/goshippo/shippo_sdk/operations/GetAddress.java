...
public class GetAddress {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAddressRequest, GetAddressResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAddressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAddressRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAddressRequest request) {
        ...
        @Override
        public GetAddressResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAddressResponse.Builder resBuilder =
                    GetAddressResponse
                            .builder()
            ...
            GetAddressResponse res = resBuilder.build();
