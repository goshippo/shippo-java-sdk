...
public class GetBatch {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBatchRequest, GetBatchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetBatchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBatchRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBatchRequest request) {
        ...
        @Override
        public GetBatchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBatchResponse.Builder resBuilder =
                    GetBatchResponse
                            .builder()
            ...
            GetBatchResponse res = resBuilder.build();
