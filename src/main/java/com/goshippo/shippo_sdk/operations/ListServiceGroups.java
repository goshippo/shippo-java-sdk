...
public class ListServiceGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListServiceGroupsRequest, ListServiceGroupsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListServiceGroupsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListServiceGroupsRequest request) {
        ...
        @Override
        public ListServiceGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListServiceGroupsResponse.Builder resBuilder =
            ...
            ListServiceGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withServiceGroupListResponse(Utils.unmarshal(response, new TypeReference<List<ServiceGroup>>() {}));
                } else {
