...
public class CreateManifest {
    ...
    public static class Sync extends Base
            implements RequestOperation<ManifestCreateRequest, CreateManifestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ManifestCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ManifestCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ManifestCreateRequest request) {
        ...
        @Override
        public CreateManifestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateManifestResponse.Builder resBuilder =
            ...
            CreateManifestResponse res = resBuilder.build();
