...
public class GetDefaultParcelTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDefaultParcelTemplateRequest, GetDefaultParcelTemplateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDefaultParcelTemplateRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDefaultParcelTemplateRequest request) {
        ...
        @Override
        public GetDefaultParcelTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDefaultParcelTemplateResponse.Builder resBuilder =
            ...
            GetDefaultParcelTemplateResponse res = resBuilder.build();
