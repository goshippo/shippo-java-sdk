...
public class PurchaseBatch {
    ...
    public static class Sync extends Base
            implements RequestOperation<PurchaseBatchRequest, PurchaseBatchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PurchaseBatchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PurchaseBatchRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PurchaseBatchRequest request) {
        ...
        @Override
        public PurchaseBatchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PurchaseBatchResponse.Builder resBuilder =
            ...
            PurchaseBatchResponse res = resBuilder.build();
