...
public class ListShipmentRates {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShipmentRatesRequest, ListShipmentRatesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShipmentRatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShipmentRatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShipmentRatesRequest request) {
        ...
        @Override
        public ListShipmentRatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShipmentRatesResponse.Builder resBuilder =
            ...
            ListShipmentRatesResponse res = resBuilder.build();
