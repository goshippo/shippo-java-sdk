...
public class CreateCustomsDeclaration {
    ...
    public static class Sync extends Base
            implements RequestOperation<CustomsDeclarationCreateRequest, CreateCustomsDeclarationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CustomsDeclarationCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CustomsDeclarationCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CustomsDeclarationCreateRequest request) {
        ...
        @Override
        public CreateCustomsDeclarationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCustomsDeclarationResponse.Builder resBuilder =
            ...
            CreateCustomsDeclarationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCustomsDeclaration(Utils.unmarshal(response, new TypeReference<CustomsDeclaration>() {}));
                } else {
