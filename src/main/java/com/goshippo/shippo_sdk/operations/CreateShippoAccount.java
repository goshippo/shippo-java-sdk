...
public class CreateShippoAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<ShippoAccountUpdateRequest, CreateShippoAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ShippoAccountUpdateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ShippoAccountUpdateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ShippoAccountUpdateRequest request) {
        ...
        @Override
        public CreateShippoAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateShippoAccountResponse.Builder resBuilder =
            ...
            CreateShippoAccountResponse res = resBuilder.build();
