...
public class ListManifests {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListManifestsRequest, ListManifestsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListManifestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListManifestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListManifestsRequest request) {
        ...
        @Override
        public ListManifestsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListManifestsResponse.Builder resBuilder =
            ...
            ListManifestsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withManifestPaginatedList(Utils.unmarshal(response, new TypeReference<ManifestPaginatedList>() {}));
                } else {
