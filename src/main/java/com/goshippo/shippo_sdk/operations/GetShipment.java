...
public class GetShipment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShipmentRequest, GetShipmentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShipmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShipmentRequest request) {
        ...
        @Override
        public GetShipmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShipmentResponse.Builder resBuilder =
                    GetShipmentResponse
                            .builder()
            ...
            GetShipmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShipment(Utils.unmarshal(response, new TypeReference<Shipment>() {}));
                } else {
