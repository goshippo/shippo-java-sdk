...
public class GetTrack {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTrackRequest, GetTrackResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTrackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTrackRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTrackRequest request) {
        ...
        @Override
        public GetTrackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTrackResponse.Builder resBuilder =
                    GetTrackResponse
                            .builder()
            ...
            GetTrackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTrack(Utils.unmarshal(response, new TypeReference<Track>() {}));
                } else {
