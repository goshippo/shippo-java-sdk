...
public class CreateCustomsItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<CustomsItemCreateRequest, CreateCustomsItemResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CustomsItemCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CustomsItemCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CustomsItemCreateRequest request) {
        ...
        @Override
        public CreateCustomsItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCustomsItemResponse.Builder resBuilder =
            ...
            CreateCustomsItemResponse res = resBuilder.build();
