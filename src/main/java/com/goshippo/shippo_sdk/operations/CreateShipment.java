...
public class CreateShipment {
    ...
    public static class Sync extends Base
            implements RequestOperation<ShipmentCreateRequest, CreateShipmentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ShipmentCreateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ShipmentCreateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ShipmentCreateRequest request) {
        ...
        @Override
        public CreateShipmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateShipmentResponse.Builder resBuilder =
            ...
            CreateShipmentResponse res = resBuilder.build();
