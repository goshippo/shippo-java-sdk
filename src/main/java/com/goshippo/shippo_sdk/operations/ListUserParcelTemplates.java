...
public class ListUserParcelTemplates {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUserParcelTemplatesRequest, ListUserParcelTemplatesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUserParcelTemplatesRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUserParcelTemplatesRequest request) {
        ...
        @Override
        public ListUserParcelTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUserParcelTemplatesResponse.Builder resBuilder =
            ...
            ListUserParcelTemplatesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUserParcelTemplateList(Utils.unmarshal(response, new TypeReference<UserParcelTemplateList>() {}));
                } else {
