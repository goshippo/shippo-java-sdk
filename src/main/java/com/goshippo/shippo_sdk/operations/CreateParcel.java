...
public class CreateParcel {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateParcelRequestBody, CreateParcelResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateParcelRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateParcelRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateParcelRequestBody request) {
        ...
        @Override
        public CreateParcelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateParcelResponse.Builder resBuilder =
            ...
            CreateParcelResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withParcel(Utils.unmarshal(response, new TypeReference<Parcel>() {}));
                } else {
