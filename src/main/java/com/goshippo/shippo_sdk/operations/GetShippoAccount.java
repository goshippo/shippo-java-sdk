...
public class GetShippoAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippoAccountRequest, GetShippoAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippoAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippoAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippoAccountRequest request) {
        ...
        @Override
        public GetShippoAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippoAccountResponse.Builder resBuilder =
            ...
            GetShippoAccountResponse res = resBuilder.build();
