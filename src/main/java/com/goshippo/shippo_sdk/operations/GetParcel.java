...
public class GetParcel {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetParcelRequest, GetParcelResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetParcelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetParcelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetParcelRequest request) {
        ...
        @Override
        public GetParcelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetParcelResponse.Builder resBuilder =
                    GetParcelResponse
                            .builder()
            ...
            GetParcelResponse res = resBuilder.build();
