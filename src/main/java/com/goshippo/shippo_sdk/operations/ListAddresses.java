...
public class ListAddresses {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAddressesRequest, ListAddressesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAddressesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAddressesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAddressesRequest request) {
        ...
        @Override
        public ListAddressesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAddressesResponse.Builder resBuilder =
            ...
            ListAddressesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAddressPaginatedList(Utils.unmarshal(response, new TypeReference<AddressPaginatedList>() {}));
                } else {
