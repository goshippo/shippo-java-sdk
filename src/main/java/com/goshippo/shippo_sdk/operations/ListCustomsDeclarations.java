...
public class ListCustomsDeclarations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCustomsDeclarationsRequest, ListCustomsDeclarationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCustomsDeclarationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCustomsDeclarationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCustomsDeclarationsRequest request) {
        ...
        @Override
        public ListCustomsDeclarationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCustomsDeclarationsResponse.Builder resBuilder =
            ...
            ListCustomsDeclarationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCustomsDeclarationPaginatedList(Utils.unmarshal(response, new TypeReference<CustomsDeclarationPaginatedList>() {}));
                } else {
