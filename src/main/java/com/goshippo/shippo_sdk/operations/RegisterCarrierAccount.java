...
public class RegisterCarrierAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<RegisterCarrierAccountRequestBody, RegisterCarrierAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RegisterCarrierAccountRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<RegisterCarrierAccountRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RegisterCarrierAccountRequestBody request) {
        ...
        @Override
        public RegisterCarrierAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RegisterCarrierAccountResponse.Builder resBuilder =
            ...
            RegisterCarrierAccountResponse res = resBuilder.build();
