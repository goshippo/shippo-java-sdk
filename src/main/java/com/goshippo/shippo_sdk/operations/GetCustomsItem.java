...
public class GetCustomsItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCustomsItemRequest, GetCustomsItemResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCustomsItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCustomsItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCustomsItemRequest request) {
        ...
        @Override
        public GetCustomsItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCustomsItemResponse.Builder resBuilder =
            ...
            GetCustomsItemResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCustomsItem(Utils.unmarshal(response, new TypeReference<CustomsItem>() {}));
                } else {
