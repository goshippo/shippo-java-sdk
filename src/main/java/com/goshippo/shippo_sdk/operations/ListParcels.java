...
public class ListParcels {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListParcelsRequest, ListParcelsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListParcelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListParcelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListParcelsRequest request) {
        ...
        @Override
        public ListParcelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListParcelsResponse.Builder resBuilder =
                    ListParcelsResponse
                            .builder()
            ...
            ListParcelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withParcelPaginatedList(Utils.unmarshal(response, new TypeReference<ParcelPaginatedList>() {}));
                } else {
