...
public class ListShippoAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShippoAccountsRequest, ListShippoAccountsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShippoAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippoAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShippoAccountsRequest request) {
        ...
        @Override
        public ListShippoAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShippoAccountsResponse.Builder resBuilder =
            ...
            ListShippoAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippoAccountPaginatedList(Utils.unmarshal(response, new TypeReference<ShippoAccountPaginatedList>() {}));
                } else {
