 ...
 * ResponseMessage
 * 
 * <p>Message returned with supporting information from a request. In some cases this can be an error
 * message,
 * for example a timeout from a carrier. If available, the origin of the message is displayed in
 * `source`.
 */
