 ...
 * 
 * <p>The recipient address, which includes the recipient's name, company name, street address, city,
 * state, zip code,
...
public class LiveRateCreateRequestAddressTo {
    ...
    public static LiveRateCreateRequestAddressTo of(String value) {
        ...
        return new LiveRateCreateRequestAddressTo(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
