 ...
 * ServiceLevel
 * 
 * <p>Used for some Service Levels to link to the more "generic" version of this Service Level - for
 * example,
 * if this Service Level is a variation specific to shipments to Europe("ups_saver_eu"), the "parent"
 * is
 * the fully generic version ("ups_saver"). Helpful when displaying Service Levels to users. Has the
 * same
 * structure of the servicelevel - "name", "token", "terms", and "extended_token", or it is otherwise
 * null.
 */
public class ServiceLevel {
    /**
     * Name of the Rate's servicelevel, e.g. `International Priority` or `Standard Post`.
     * A servicelevel commonly defines the transit time of a Shipment (e.g., Express vs. Standard), along
     ...
     * Guaranteed to be unique across all Service Levels, and may help offer insight into the specific
     * Service Level it describes.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.extendedToken, other.extendedToken);
    }
