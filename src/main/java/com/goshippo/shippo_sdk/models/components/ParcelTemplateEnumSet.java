 ...
 * 
 * <p>If template is passed, `length`, `width`, `height`, and `distance_unit` are not required
 */
...
public class ParcelTemplateEnumSet {
    ...
    public static ParcelTemplateEnumSet of(ParcelTemplateFedExEnum value) {
        ...
        return new ParcelTemplateEnumSet(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
