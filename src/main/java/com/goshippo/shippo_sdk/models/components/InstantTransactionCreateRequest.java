...
public class InstantTransactionCreateRequest {
    ...
    public InstantTransactionCreateRequest(
        ...
        this(Optional.empty(), carrierAccount, Optional.empty(),
            Optional.empty(), servicelevelToken, shipment,
            Optional.empty());
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            async, carrierAccount, labelFileType,
            metadata, servicelevelToken, shipment,
            order);
    }
