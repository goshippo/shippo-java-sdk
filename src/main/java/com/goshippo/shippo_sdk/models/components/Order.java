...
public class Order {
     ...
     * 
     * <p>Currency of the `total_price` and `total_tax` amounts.
     */
    ...
    /**
     * An alphanumeric identifier for the order used by the seller/buyer. This identifier doesn't need to
     * be unique.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * Date and time when the order was placed. This datetime can be different from the datetime of the
     * order object creation on Shippo.
     */
    @JsonProperty("placed_at")
    private String placedAt;

    /**
     * Amount paid by the buyer for shipping. This amount can be different from the price the seller will
     * actually pay for shipping.
     */
    @JsonInclude(Include.NON_ABSENT)
     ...
     * 
     * <p>Currency of the `shipping_cost` amount.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * Array of [line item](/shippoapi/public-api/orders/lineitem) objects representing the items in this
     * order.
    ...
    /**
     * Array of [transaction](/shippoapi/public-api/transactions) objects representing all shipping labels
    ...
    public Order(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), placedAt, Optional.empty(),
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), Optional.empty(), toAddress,
            Optional.empty(), Optional.empty(), Optional.empty(),
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.placedAt, other.placedAt) &&
            Utils.enhancedDeepEquals(this.shippingCost, other.shippingCost) &&
            Utils.enhancedDeepEquals(this.shippingCostCurrency, other.shippingCostCurrency) &&
            Utils.enhancedDeepEquals(this.shippingMethod, other.shippingMethod) &&
            Utils.enhancedDeepEquals(this.subtotalPrice, other.subtotalPrice) &&
            ...
            Utils.enhancedDeepEquals(this.shopApp, other.shopApp) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            currency, notes, orderNumber,
            orderStatus, placedAt, shippingCost,
            shippingCostCurrency, shippingMethod, subtotalPrice,
            totalPrice, totalTax, weight,
            weightUnit, fromAddress, toAddress,
            lineItems, objectId, objectOwner,
            shopApp, transactions);
    }
