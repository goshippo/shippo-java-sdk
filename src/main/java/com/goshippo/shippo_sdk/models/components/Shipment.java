 ...
 * Shipment
 * 
 * <p>Shipment represents the parcel as retrieved from the database
 */
public class Shipment {
    ...
    /**
     * [Address](/shippoapi/public-api/addresses) object of the sender / seller. Will be returned expanded
     * by default.
     */
    ...
    /**
     * ID of the Address object where the shipment will be sent back to if it is not delivered (Only
     * available for UPS, USPS, and Fedex shipments).
     * 
     * <p>If this field is not set, your shipments will be returned to the address_from.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * [Address](/shippoapi/public-api/addresses) object of the recipient / buyer. Will be returned
     * expanded by default.
     */
    ...
    /**
     * An array of object_ids of the carrier account objects to be used for getting shipping rates for this
     * shipment.
     * If no carrier account object_ids are set in this field, Shippo will attempt to generate rates using
     * all the
    ...
    public Shipment(
        ...
        this(Optional.empty(), metadata, Optional.empty(),
            addressFrom, Optional.empty(), addressTo,
            carrierAccounts, Optional.empty(), messages,
            objectCreated, objectId, objectOwner,
            objectUpdated, parcels, rates,
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.shipmentDate, other.shipmentDate) &&
            Utils.enhancedDeepEquals(this.addressFrom, other.addressFrom) &&
            Utils.enhancedDeepEquals(this.addressReturn, other.addressReturn) &&
            Utils.enhancedDeepEquals(this.addressTo, other.addressTo) &&
            Utils.enhancedDeepEquals(this.carrierAccounts, other.carrierAccounts) &&
            ...
            Utils.enhancedDeepEquals(this.parcels, other.parcels) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            extra, metadata, shipmentDate,
            addressFrom, addressReturn, addressTo,
            carrierAccounts, customsDeclaration, messages,
            objectCreated, objectId, objectOwner,
            objectUpdated, parcels, rates,
            status, test);
    }
