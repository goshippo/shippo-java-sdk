 ...
 * | USPS_LargeVideoFlatRateBox | Flat Rate Large Video Box (Int&amp;#39;l only) |  9.60 x 6.40 x 2.20
 * in |
...
public enum ParcelTemplateUSPSEnum {
    ...
    ParcelTemplateUSPSEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ParcelTemplateUSPSEnum> fromValue(String value) {
        for (ParcelTemplateUSPSEnum o: ParcelTemplateUSPSEnum.values()) {
