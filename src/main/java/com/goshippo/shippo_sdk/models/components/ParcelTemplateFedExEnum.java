...
public enum ParcelTemplateFedExEnum {
    ...
    ParcelTemplateFedExEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ParcelTemplateFedExEnum> fromValue(String value) {
        for (ParcelTemplateFedExEnum o: ParcelTemplateFedExEnum.values()) {
