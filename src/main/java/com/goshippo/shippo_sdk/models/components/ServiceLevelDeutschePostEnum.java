...
/**
 * ServiceLevelDeutschePostEnum - |Token | Service name|
 * |:---|:---|
...
public enum ServiceLevelDeutschePostEnum {
    ...
    private ServiceLevelDeutschePostEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceLevelDeutschePostEnum> fromValue(String value) {
        for (ServiceLevelDeutschePostEnum o: ServiceLevelDeutschePostEnum.values()) {
