 ...
 * AddressImporter
 * 
 * <p>Object that represents the address of the importer
 */
public class AddressImporter {
    ...
    /**
     * First street line, 35 character limit. Usually street number and street name (except for DHL
     * Germany, see street_no).
     */
    @JsonInclude(Include.NON_ABSENT)
