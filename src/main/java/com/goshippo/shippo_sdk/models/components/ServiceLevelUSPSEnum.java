 ...
 * | usps_media_mail | Media Mail, only for existing Shippo customers with grandfathered Media Mail
 * option.|
...
public enum ServiceLevelUSPSEnum {
    ...
    ServiceLevelUSPSEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceLevelUSPSEnum> fromValue(String value) {
        for (ServiceLevelUSPSEnum o: ServiceLevelUSPSEnum.values()) {
