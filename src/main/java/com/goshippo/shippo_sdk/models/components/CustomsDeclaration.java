...
public class CustomsDeclaration {
    ...
    /**
     * B13A Option details are obtained by filing a B13A Canada Export Declaration via the Canadian Export
     * Reporting System (CERS).
     * [More information on reporting commercial exports from
     * Canada.](https://www.cbsa-asfc.gc.ca/services/export/guide-eng.html)
    ...
    /**
     * EEL / PFC type of the shipment. For most shipments from the US to CA, `NOEEI_30_36` is applicable;
     * for most
    ...
    public CustomsDeclaration(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            ...
            nonDeliveryOption, Optional.empty(), Optional.empty(),
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty());
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.invoicedCharges, other.invoicedCharges) &&
            ...
            Utils.enhancedDeepEquals(this.objectState, other.objectState) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            incoterm, invoicedCharges, items,
            nonDeliveryOption, objectCreated, objectId,
            objectOwner, objectState, objectUpdated,
            test);
    }
