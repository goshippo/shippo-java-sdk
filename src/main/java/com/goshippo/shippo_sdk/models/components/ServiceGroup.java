...
public class ServiceGroup {
    ...
    /**
     * The amount in percent (%) that the service group's returned rate should be adjusted. For example, if
     * this field is set to 5 and the matched rate price is $5.00, the returned value of the service group
     * will be $5.25. Negative integers are also accepted and will discount the rate price by the defined
     * percentage amount.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public ServiceGroup(
        ...
        this(description, Optional.empty(), Optional.empty(),
            ...
            Optional.empty(), type, objectId,
            Optional.empty(), serviceLevels);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.flatRate, other.flatRate) &&
            Utils.enhancedDeepEquals(this.flatRateCurrency, other.flatRateCurrency) &&
            Utils.enhancedDeepEquals(this.freeShippingThresholdCurrency, other.freeShippingThresholdCurrency) &&
            Utils.enhancedDeepEquals(this.freeShippingThresholdMin, other.freeShippingThresholdMin) &&
            Utils.enhancedDeepEquals(this.name, other.name) &&
            Utils.enhancedDeepEquals(this.rateAdjustment, other.rateAdjustment) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            description, flatRate, flatRateCurrency,
            freeShippingThresholdCurrency, freeShippingThresholdMin, name,
            rateAdjustment, type, objectId,
            isActive, serviceLevels);
    }
