...
public class Manifest {
    ...
    public Manifest(
        ...
        this(carrierAccount, shipmentDate, Optional.empty(),
            addressFrom, documents, Optional.empty(),
            objectCreated, objectId, objectOwner,
            objectUpdated, status);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            carrierAccount, shipmentDate, transactions,
            addressFrom, documents, errors,
            objectCreated, objectId, objectOwner,
            objectUpdated, status);
    }
