 ...
 * 
 * <p>An array of additional parameters for the account, such as e.g. password or token.
 * Please check the [carrier accounts
 * tutorial](https://docs.goshippo.com/docs/carriers/carrieraccounts/) page for the parameters per
 * carrier.
...
public class UPSConnectExistingOwnAccountParameters {
    ...
    /**
     * true if user has been issued a UPS invoice within the past 90 days for the US or Canada; and 45 days
     * for any other countries. User can use data from any of the last 3 invoices
     */
    ...
    /**
     * Whether the user agrees to the UPS terms and conditions or not. Error 400 will be returned if passed
     * in as false
     */
    ...
    public UPSConnectExistingOwnAccountParameters(
        ...
        this(accountNumber, Optional.empty(), billingAddressCity,
            billingAddressCountryIso2, billingAddressState, billingAddressStreet1,
            Optional.empty(), billingAddressZip, collecCountryIso2,
            collecZip, company, Optional.empty(),
            email, fullName, hasInvoice,
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), phone, title,
            upsAgreements);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.aiaCountryIso2, other.aiaCountryIso2) &&
            Utils.enhancedDeepEquals(this.billingAddressCity, other.billingAddressCity) &&
            Utils.enhancedDeepEquals(this.billingAddressCountryIso2, other.billingAddressCountryIso2) &&
            Utils.enhancedDeepEquals(this.billingAddressState, other.billingAddressState) &&
            Utils.enhancedDeepEquals(this.billingAddressStreet1, other.billingAddressStreet1) &&
            Utils.enhancedDeepEquals(this.billingAddressStreet2, other.billingAddressStreet2) &&
            Utils.enhancedDeepEquals(this.billingAddressZip, other.billingAddressZip) &&
            Utils.enhancedDeepEquals(this.collecCountryIso2, other.collecCountryIso2) &&
            Utils.enhancedDeepEquals(this.collecZip, other.collecZip) &&
            ...
            Utils.enhancedDeepEquals(this.hasInvoice, other.hasInvoice) &&
            Utils.enhancedDeepEquals(this.invoiceControlid, other.invoiceControlid) &&
            ...
            Utils.enhancedDeepEquals(this.invoiceValue, other.invoiceValue) &&
            Utils.enhancedDeepEquals(this.phone, other.phone) &&
            Utils.enhancedDeepEquals(this.title, other.title) &&
            Utils.enhancedDeepEquals(this.upsAgreements, other.upsAgreements);
    }
    
    @Override
    public int hashCode() {
        return Utils.enhancedHash(
            accountNumber, aiaCountryIso2, billingAddressCity,
            billingAddressCountryIso2, billingAddressState, billingAddressStreet1,
            billingAddressStreet2, billingAddressZip, collecCountryIso2,
            collecZip, company, currencyCode,
            email, fullName, hasInvoice,
            invoiceControlid, invoiceDate, invoiceNumber,
            invoiceValue, phone, title,
            upsAgreements);
    }
