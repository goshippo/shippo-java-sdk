...
public enum ServiceLevelFedExEnum {
    ...
    ServiceLevelFedExEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceLevelFedExEnum> fromValue(String value) {
        for (ServiceLevelFedExEnum o: ServiceLevelFedExEnum.values()) {
