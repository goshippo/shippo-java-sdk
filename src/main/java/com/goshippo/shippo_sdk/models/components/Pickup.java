...
public class Pickup {
     ...
     * You can retrieve this from your Rate requests or our [Carrier
     * Accounts](/shippoapi/public-api/carrier-accounts) endpoint.
     */
    ...
    public Pickup(
        ...
        this(carrierAccount, location, Optional.empty(),
            requestedEndTime, requestedStartTime, transactions,
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.requestedEndTime, other.requestedEndTime) &&
            Utils.enhancedDeepEquals(this.requestedStartTime, other.requestedStartTime) &&
            ...
            Utils.enhancedDeepEquals(this.confirmedStartTime, other.confirmedStartTime) &&
            Utils.enhancedDeepEquals(this.confirmedEndTime, other.confirmedEndTime) &&
            Utils.enhancedDeepEquals(this.cancelByTime, other.cancelByTime) &&
            Utils.enhancedDeepEquals(this.status, other.status) &&
            Utils.enhancedDeepEquals(this.confirmationCode, other.confirmationCode) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            carrierAccount, location, metadata,
            requestedEndTime, requestedStartTime, transactions,
            objectCreated, objectId, objectUpdated,
            confirmedStartTime, confirmedEndTime, cancelByTime,
            status, confirmationCode, timezone,
            messages, isTest);
    }
