...
public class Parcel {
    ...
    /**
     * Weight of the parcel. Up to six digits in front and four digits after the decimal separator are
     * accepted.
     */
    @JsonProperty("weight")
    ...
    /**
     * Height of the parcel. Up to six digits in front and four digits after the decimal separator are
     * accepted.
     */
    @JsonProperty("height")
    ...
    /**
     * Length of the Parcel. Up to six digits in front and four digits after the decimal separator are
     * accepted.
     */
    @JsonProperty("length")
    ...
    /**
     * Width of the Parcel. Up to six digits in front and four digits after the decimal separator are
     * accepted.
     */
    @JsonProperty("width")
    ...
    /**
     * Date and time of last Parcel update. Since you cannot update Parcels after they were created, this
     * time stamp reflects the time when the Parcel was changed by Shippo's systems for the last time,
     * e.g., during sorting the dimensions given.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public Parcel(
            ...
            String length,
            String width) {
        this(Optional.empty(), Optional.empty(), massUnit,
            weight, distanceUnit, height,
            length, width, Optional.empty(),
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            extra, metadata, massUnit,
            weight, distanceUnit, height,
            length, width, objectCreated,
            objectId, objectOwner, objectState,
            objectUpdated, template, test);
    }
