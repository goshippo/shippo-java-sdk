 ...
 * | UPS_MI_BPM_Flat | BPM Flat (Mail Innovations - Domestic &amp;amp; International) | 0.00 x 0.00 x
 * 0.00 in|
 * | UPS_MI_BPM_Parcel | BPM Parcel (Mail Innovations - Domestic &amp;amp; International) | 0.00 x 0.00
 * x 0.00 in|
...
public enum ParcelTemplateUPSEnum {
    ...
    ParcelTemplateUPSEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ParcelTemplateUPSEnum> fromValue(String value) {
        for (ParcelTemplateUPSEnum o: ParcelTemplateUPSEnum.values()) {
