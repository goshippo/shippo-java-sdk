...
public enum ServiceLevelEvriUKEnum {
    ...
    ServiceLevelEvriUKEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceLevelEvriUKEnum> fromValue(String value) {
        for (ServiceLevelEvriUKEnum o: ServiceLevelEvriUKEnum.values()) {
