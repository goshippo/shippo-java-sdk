 ...
 * TransactionRate
 * 
 * <p>ID of the Rate object for which a Label has to be obtained.
...
public class TransactionRate {
    ...
    public static TransactionRate of(CoreRate value) {
        ...
        return new TransactionRate(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
     ...
     * <ul>
     * <li>{@code com.goshippo.shippo_sdk.models.components.CoreRate}</li>
