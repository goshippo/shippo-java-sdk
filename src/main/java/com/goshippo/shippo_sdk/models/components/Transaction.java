...
public class Transaction {
     ...
     * A value will only be returned if the Transactions has been processed successfully and if the
     ...
     * A value will only be returned if requested using qr_code_requested flag and the carrier provides
     * such an option.
     */
    @JsonInclude(Include.NON_ABSENT)
     ...
     * A value will only be returned if the Rate is for a trackable Shipment and if the Transactions has
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            Utils.enhancedDeepEquals(this.commercialInvoiceUrl, other.commercialInvoiceUrl) &&
            Utils.enhancedDeepEquals(this.createdBy, other.createdBy) &&
            Utils.enhancedDeepEquals(this.eta, other.eta) &&
            ...
            Utils.enhancedDeepEquals(this.parcel, other.parcel) &&
            Utils.enhancedDeepEquals(this.qrCodeUrl, other.qrCodeUrl) &&
            ...
            Utils.enhancedDeepEquals(this.trackingUrlProvider, other.trackingUrlProvider);
    }
    
    @Override
    public int hashCode() {
        return Utils.enhancedHash(
            commercialInvoiceUrl, createdBy, eta,
            labelFileType, labelUrl, messages,
            metadata, objectCreated, objectId,
            objectOwner, objectState, objectUpdated,
            parcel, qrCodeUrl, rate,
            status, test, trackingNumber,
            trackingStatus, trackingUrlProvider);
    }
