...
public class CustomsItem {
    ...
    /**
     * HS code of the item, which is required by some carriers. If `tariff_number` is not provided,
     * `hs_code` will be used. If both `hs_code` and `tariff_number` are provided, `tariff_number` will be
     * used.
     * 
     * <p>50 character limit.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * The tariff number of the item. If `tariff_number` is not provided, `hs_code` will be used. If both
     * `hs_code` and `tariff_number` are provided, `tariff_number` will be used.
     * 
     * <p>12 character limit.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public CustomsItem(
        ...
        this(description, Optional.empty(), massUnit,
            Optional.empty(), netWeight, originCountry,
            quantity, Optional.empty(), Optional.empty(),
            Optional.empty(), valueAmount, valueCurrency,
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.eccnEar99, other.eccnEar99) &&
            Utils.enhancedDeepEquals(this.massUnit, other.massUnit) &&
            Utils.enhancedDeepEquals(this.metadata, other.metadata) &&
            Utils.enhancedDeepEquals(this.netWeight, other.netWeight) &&
            Utils.enhancedDeepEquals(this.originCountry, other.originCountry) &&
            Utils.enhancedDeepEquals(this.quantity, other.quantity) &&
            Utils.enhancedDeepEquals(this.skuCode, other.skuCode) &&
            Utils.enhancedDeepEquals(this.hsCode, other.hsCode) &&
            Utils.enhancedDeepEquals(this.tariffNumber, other.tariffNumber) &&
            Utils.enhancedDeepEquals(this.valueAmount, other.valueAmount) &&
            Utils.enhancedDeepEquals(this.valueCurrency, other.valueCurrency) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            description, eccnEar99, massUnit,
            metadata, netWeight, originCountry,
            quantity, skuCode, hsCode,
            tariffNumber, valueAmount, valueCurrency,
            objectCreated, objectId, objectOwner,
            objectState, objectUpdated, test);
    }
