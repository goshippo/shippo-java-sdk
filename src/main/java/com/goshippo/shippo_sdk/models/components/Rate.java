...
public class Rate {
    ...
    /**
     * Predicted time the carrier will deliver the package in the destination's local time zone. In the
     * format `HH:MM:SS`.
     */
     ...
     * Often, this includes notes that the transit time as given in "days" is only an average, not a
     * guaranteed time.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * Cost to the user to insure the Rate for the requested amount of coverage, if insurance coverage was
     * requested.
     * Expressed in the currency used in the sender's country. Will be null if no insurance coverage was
     * requested, or if insurance is requested from a non-standard insurance provider.
     * Please note this price is already included in the `amount` and `amount_local` fields on the Rate. Do
     * not add this field to them.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public Rate(
            ...
            String shipment) {
        this(amount, amountLocal, currency,
            currencyLocal, Optional.empty(), attributes,
            carrierAccount, Optional.empty(), Optional.empty(),
            Optional.empty(), Optional.empty(), objectCreated,
            objectId, objectOwner, provider,
            Optional.empty(), Optional.empty(), servicelevel,
            shipment, Optional.empty(), Optional.empty());
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.arrivesBy, other.arrivesBy) &&
            ...
            Utils.enhancedDeepEquals(this.durationTerms, other.durationTerms) &&
            Utils.enhancedDeepEquals(this.estimatedDays, other.estimatedDays) &&
            Utils.enhancedDeepEquals(this.includedInsurancePrice, other.includedInsurancePrice) &&
            ...
            Utils.enhancedDeepEquals(this.providerImage75, other.providerImage75) &&
            Utils.enhancedDeepEquals(this.providerImage200, other.providerImage200) &&
            Utils.enhancedDeepEquals(this.servicelevel, other.servicelevel) &&
            Utils.enhancedDeepEquals(this.shipment, other.shipment) &&
            Utils.enhancedDeepEquals(this.test, other.test) &&
            Utils.enhancedDeepEquals(this.zone, other.zone);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            currencyLocal, arrivesBy, attributes,
            carrierAccount, durationTerms, estimatedDays,
            includedInsurancePrice, messages, objectCreated,
            objectId, objectOwner, provider,
            providerImage75, providerImage200, servicelevel,
            shipment, test, zone);
    }
