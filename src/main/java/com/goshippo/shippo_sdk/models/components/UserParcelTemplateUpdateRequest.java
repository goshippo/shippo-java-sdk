...
public class UserParcelTemplateUpdateRequest {
    ...
    /**
     * The height of the package, in units specified by the `distance_unit` attribute. Required, but if
    ...
    /**
     * The length of the package, in units specified by the `distance_unit` attribute. Required, but if
     * using a preset carrier template then this field must be empty.
     */
    @JsonProperty("length")
    ...
    /**
     * The width of the package, in units specified by the `distance_unit` attribute. Required, but if
     * using a preset carrier template then this field must be empty.
     */
    @JsonProperty("width")
    ...
    public UserParcelTemplateUpdateRequest(
            ...
            String name,
            String width) {
        this(distanceUnit, height, length,
     ...
     * The measure unit used for length, width and height.
     */
    public UserParcelTemplateUpdateRequest withDistanceUnit(DistanceUnitEnum distanceUnit) {
        Utils.checkNotNull(distanceUnit, "distanceUnit");
        this.distanceUnit = distanceUnit;
        return this;
    }
     ...
     * using a preset carrier template then this field must be empty.
     */
    public UserParcelTemplateUpdateRequest withHeight(String height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
     ...
     * using a preset carrier template then this field must be empty.
     */
    public UserParcelTemplateUpdateRequest withLength(String length) {
        Utils.checkNotNull(length, "length");
        this.length = length;
        return this;
    }
     ...
     * The name of the User Parcel Template
     */
    public UserParcelTemplateUpdateRequest withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The weight of the package, in units specified by the weight_unit attribute.
     */
    public UserParcelTemplateUpdateRequest withWeight(String weight) {
        Utils.checkNotNull(weight, "weight");
     ...
     * The weight of the package, in units specified by the weight_unit attribute.
     */
    public UserParcelTemplateUpdateRequest withWeight(Optional<String> weight) {
        Utils.checkNotNull(weight, "weight");
        this.weight = weight;
        return this;
    }
     ...
     * The unit used for weight.
     */
    public UserParcelTemplateUpdateRequest withWeightUnit(WeightUnitEnum weightUnit) {
        Utils.checkNotNull(weightUnit, "weightUnit");
     ...
     * The unit used for weight.
     */
    public UserParcelTemplateUpdateRequest withWeightUnit(Optional<? extends WeightUnitEnum> weightUnit) {
        Utils.checkNotNull(weightUnit, "weightUnit");
        this.weightUnit = weightUnit;
        return this;
    }
     ...
     * using a preset carrier template then this field must be empty.
     */
    public UserParcelTemplateUpdateRequest withWidth(String width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UserParcelTemplateUpdateRequest other = (UserParcelTemplateUpdateRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UserParcelTemplateUpdateRequest.class,
    ...
    public final static class Builder {
        ...
        public UserParcelTemplateUpdateRequest build() {

            return new UserParcelTemplateUpdateRequest(
                distanceUnit, height, length,
                name, weight, weightUnit,
                width);
        }
