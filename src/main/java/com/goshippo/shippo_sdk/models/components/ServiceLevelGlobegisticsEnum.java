 ...
 * |:---|:---|
 * | globegistics_priority_mail_express_international | Globegistics Priority Mail Express
 * International|
 * | globegistics_priority_mail_international | Globegistics Priority Mail International|
 * | globegistics_priority_mail_express_international_pds | Globegistics Priority Mail Express
 * International PreSort Drop Ship|
 * | globegistics_priority_mail_international_pds | Globegistics Priority Mail International PreSort
 * Drop Ship|
 ...
 * | globegistics_ecom_priority_mail_international_ddp | Globegistics eCom Priority Mail International
 * DDP|
 * | globegistics_ecom_priority_mail_express_international_ddp | Globegistics eCom Priority Mail
 * Express International DDP|
 * | globegistics_ecom_extra | Globegistics eCom Extra|
 * | globegistics_ecom_international_priority_airmail | Globegistics eCom International Priority
 * Airmail|
 * | globegistics_ecom_international_surface_airlift | Globegistics eCom International Surface Air
 * Lift|
 */
public enum ServiceLevelGlobegisticsEnum {
    ...
    ServiceLevelGlobegisticsEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceLevelGlobegisticsEnum> fromValue(String value) {
        for (ServiceLevelGlobegisticsEnum o: ServiceLevelGlobegisticsEnum.values()) {
