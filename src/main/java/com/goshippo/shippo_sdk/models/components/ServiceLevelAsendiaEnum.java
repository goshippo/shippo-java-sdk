...
public enum ServiceLevelAsendiaEnum {
    ...
    ServiceLevelAsendiaEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ServiceLevelAsendiaEnum> fromValue(String value) {
        for (ServiceLevelAsendiaEnum o: ServiceLevelAsendiaEnum.values()) {
