...
public class LiveRateCreateRequest {
    ...
    /**
     * The recipient address, which includes the recipient's name, company name, street address, city,
     * state, zip code,
     * country, phone number, and email address (strings). Special characters should not be included in
     * any address element, especially name, company, and email.
     */
    ...
    public LiveRateCreateRequest(
        ...
        this(Optional.empty(), addressTo, lineItems,
            Optional.empty());
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            addressFrom, addressTo, lineItems,
            parcel);
    }
